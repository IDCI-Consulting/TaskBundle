...
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "triggerVueEditor", function() { return triggerVueEditor; });
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_3__store_getters_js__ = __webpack_require__(12);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_3__store_getters_js___default = __webpack_require__.n(__WEBPACK_IMPORTED_MODULE_3__store_getters_js__);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_4__store_mutations_js__ = __webpack_require__(26);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_4__store_mutations_js___default = __webpack_require__.n(__WEBPACK_IMPORTED_MODULE_4__store_mutations_js__);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_5__store_actions_js__ = __webpack_require__(27);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_5__store_actions_js___default = __webpack_require__.n(__WEBPACK_IMPORTED_MODULE_5__store_actions_js__);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_6_ExtraFormBundle_store_getters_js__ = __webpack_require__(23);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_6_ExtraFormBundle_store_getters_js___default = __webpack_require__.n(__WEBPACK_IMPORTED_MODULE_6_ExtraFormBundle_store_getters_js__);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_7_ExtraFormBundle_store_actions_js__ = __webpack_require__(24);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_7_ExtraFormBundle_store_actions_js___default = __webpack_require__.n(__WEBPACK_IMPORTED_MODULE_7_ExtraFormBundle_store_actions_js__);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_8_ExtraFormBundle_store_mutations_js__ = __webpack_require__(25);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_8_ExtraFormBundle_store_mutations_js___default = __webpack_require__.n(__WEBPACK_IMPORTED_MODULE_8_ExtraFormBundle_store_mutations_js__);
...
function triggerVueEditor(element, configuration) {
  let workflowEditor = {
    ...
    promise: __webpack_require__.e/* import() */(1).then(__webpack_require__.bind(null, 13))
  };

  Promise.all([workflowEditor.promise]).then(function (components) {

    components.forEach(function (component) {
      __WEBPACK_IMPORTED_MODULE_0_vue___default.a.component(workflowEditor.componentName, component.default);
    });
    ...
    const store = new __WEBPACK_IMPORTED_MODULE_1_vuex___default.a.Store({
      ...
      getters: Object.assign(
        __WEBPACK_IMPORTED_MODULE_3__store_getters_js___default.a,
        __WEBPACK_IMPORTED_MODULE_6_ExtraFormBundle_store_getters_js___default.a
      ),

      actions: Object.assign(
          __WEBPACK_IMPORTED_MODULE_5__store_actions_js___default.a,
          __WEBPACK_IMPORTED_MODULE_7_ExtraFormBundle_store_actions_js___default.a
      ),

      mutations: Object.assign(
        __WEBPACK_IMPORTED_MODULE_4__store_mutations_js___default.a,
        __WEBPACK_IMPORTED_MODULE_8_ExtraFormBundle_store_mutations_js___default.a
      )
    });
    ...
    new __WEBPACK_IMPORTED_MODULE_0_vue___default.a({
      ...
      beforeCreate: function () {
        store.dispatch('setActionsList', this.$http);
      }
    });
  });
}
...
exports.default = {
  ...
  getActionsList: function getActionsList(state) {
    return state.actions;
  },

  getActionParameters: function getActionParameters(state) {
...
exports.default = {
  ...
  configuredTypesEditionAllowed: function configuredTypesEditionAllowed(state) {
    return state.configuration.allow_configured_types_edition;
  },

  showConfiguredTypes: function showConfiguredTypes(state) {
    return state.configuration.show_configured_types;
  },

  getConfiguredExtraFormTypesTags: function getConfiguredExtraFormTypesTags(state) {
    return state.configuration.configured_types_tags;
  },

  getConfiguredExtraFormTypesApiUrl: function getConfiguredExtraFormTypesApiUrl(state) {
  ...
  getBaseExtraFormTypesApiUrl: function getBaseExtraFormTypesApiUrl(state) {
    return state.configuration.api_url.get_extra_form_types;
  },

  postConfiguredExtraFormTypesApiUrl: function postConfiguredExtraFormTypesApiUrl(state) {
    return state.configuration.api_url.post_configured_extra_form_types;
  },

  putConfiguredExtraForTypesApiUrl: function putConfiguredExtraForTypesApiUrl(state) {
    return function (name) {
      return state.configuration.api_url.put_configured_extra_form_types.replace('XNAME', name);
    };
  },

  deleteConfiguredExtraForTypesApiUrl: function deleteConfiguredExtraForTypesApiUrl(state) {
    return function (name) {
      return state.configuration.api_url.delete_configured_extra_form_types.replace('XNAME', name);
    };
  },

  getExtraFormTypeOptionsApiUrl: function getExtraFormTypeOptionsApiUrl(state) {
    return function (type) {
      return state.configuration.api_url.get_extra_form_type_options.replace('XTYPE', type);
    };
  },

  getExtraFormConstraintsApiUrl: function getExtraFormConstraintsApiUrl(state) {
  ...
  getConfiguredExtraFormTypes: function getConfiguredExtraFormTypes(state) {
    return state.configuredTypes;
  },

  getConfiguredExtraFormType: function getConfiguredExtraFormType(state) {
    return function (name) {
  ...
  getBaseExtraFormTypes: function getBaseExtraFormTypes(state) {
    return state.baseTypes;
  },

  getExtraFormTypeIcon: function getExtraFormTypeIcon(state) {
    return function (type) {
      for (var i = 0, len = state.baseTypes.length; i < len; i++) {
        if (state.baseTypes[i].form_type_name === type && typeof state.baseTypes[i].icon !== 'undefined') {
...
var extraFormEditorActions = {
   ...
   * @param $http
   */
  setBaseExtraFormTypes: function setBaseExtraFormTypes($store, $http) {
   ...
   * @param $http
   */
  setConfiguredExtraFormTypes: function setConfiguredExtraFormTypes($store, $http) {
...
exports.default = extraFormEditorActions;
...
exports.default = {
  ...
  addConfiguredType: function addConfiguredType(state, type) {
    state.configuredTypes.push(type);
  },

  removeConfiguredType: function removeConfiguredType(state, index) {
    state.configuredTypes.splice(index, 1);
  },

  updateConfiguredType: function updateConfiguredType(state, type) {
  ...
  setBaseExtraFormTypes: function setBaseExtraFormTypes(state, types) {
    state.baseTypes = types;
  },

  setConfiguredExtraFormTypes: function setConfiguredExtraFormTypes(state, types) {
...
exports.default = {
   ...
   */
  setActionsList: function setActionsList(state, actions) {
    state.actions = actions;
  },

  setActionParameters: function setActionParameters(state, action, parameters) {
    state.actionParameters[action] = parameters;
  }
};
...
var workflowEditorActions = {
  /**
   * Set the actions list retrieved from the API.
   *
   * @param {Object} $store - The store.
   * @param {Object} $http  - The Vue Resource http object.
   */
  setActionsList: function setActionsList($store, $http) {
  ...
  setActionsParameters: function setActionsParameters($store, $http, action) {
    workflowEditorActions.handleGetRequest($store.getters.getActionParametersUrl(action), $store, $http, function (parameters) {
      $store.commit('setActionParameters', actions, parameters);
    });
  }
};
...
//# sourceMappingURL=vue-editor.async.js.map