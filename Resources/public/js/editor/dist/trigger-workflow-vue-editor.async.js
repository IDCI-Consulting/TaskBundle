...
"use strict";
Object.defineProperty(exports,"__esModule",{value:true});exports.triggerVueEditor=undefined;var _vue=__webpack_require__(13);var _vue2=_interopRequireDefault(_vue);var _vuex=__webpack_require__(17);var _vuex2=_interopRequireDefault(_vuex);var _vueResource=__webpack_require__(18);var _vueResource2=_interopRequireDefault(_vueResource);var _vueMultiselect=__webpack_require__(11);var _vueMultiselect2=_interopRequireDefault(_vueMultiselect);var _vueEditorCommons=__webpack_require__(0);var _editor=__webpack_require__(54);var _editor2=_interopRequireDefault(_editor);var _getters=__webpack_require__(85);var _getters2=_interopRequireDefault(_getters);var _mutations=__webpack_require__(86);var _mutations2=_interopRequireDefault(_mutations);var _actions=__webpack_require__(87);var _actions2=_interopRequireDefault(_actions);function _interopRequireDefault(obj){return obj&&obj.__esModule?obj:{default:obj};}/**
...
/* WEBPACK VAR INJECTION */(function(module) {var __WEBPACK_AMD_DEFINE_FACTORY__, __WEBPACK_AMD_DEFINE_ARRAY__, __WEBPACK_AMD_DEFINE_RESULT__;var _typeof=typeof Symbol==="function"&&typeof Symbol.iterator==="symbol"?function(obj){return typeof obj;}:function(obj){return obj&&typeof Symbol==="function"&&obj.constructor===Symbol&&obj!==Symbol.prototype?"symbol":typeof obj;};!function(t,e){"object"==( false?"undefined":_typeof(exports))&&"object"==( false?"undefined":_typeof(module))?module.exports=e(): true?!(__WEBPACK_AMD_DEFINE_ARRAY__ = [], __WEBPACK_AMD_DEFINE_FACTORY__ = (e),
				...
				__WEBPACK_AMD_DEFINE_RESULT__ !== undefined && (module.exports = __WEBPACK_AMD_DEFINE_RESULT__)):"object"==(typeof exports==="undefined"?"undefined":_typeof(exports))?exports.VueMultiselect=e():t.VueMultiselect=e();}(undefined,function(){return function(t){function e(n){if(i[n])return i[n].exports;var s=i[n]={i:n,l:!1,exports:{}};return t[n].call(s.exports,s,s.exports,e),s.l=!0,s.exports;}var i={};return e.m=t,e.c=i,e.i=function(t){return t;},e.d=function(t,i,n){e.o(t,i)||Object.defineProperty(t,i,{configurable:!1,enumerable:!0,get:n});},e.n=function(t){var i=t&&t.__esModule?function(){return t.default;}:function(){return t;};return e.d(i,"a",i),i;},e.o=function(t,e){return Object.prototype.hasOwnProperty.call(t,e);},e.p="/",e(e.s=4);}([function(t,e,i){"use strict";function n(t,e,i){return e in t?Object.defineProperty(t,e,{value:i,enumerable:!0,configurable:!0,writable:!0}):t[e]=i,t;}function s(t){return 0!==t&&(!(!Array.isArray(t)||0!==t.length)||!t);}function l(t,e){return void 0===t&&(t="undefined"),null===t&&(t="null"),!1===t&&(t="false"),-1!==t.toString().toLowerCase().indexOf(e.trim());}function o(t,e,i,n){return t.filter(function(t){return l(n(t,i),e);});}function r(t){return t.filter(function(t){return!t.$isLabel;});}function a(t,e){return function(i){return i.reduce(function(i,n){return n[t]&&n[t].length?(i.push({$groupLabel:n[e],$isLabel:!0}),i.concat(n[t])):i;},[]);};}function u(t,e,i,s,l){return function(r){return r.map(function(r){var a;if(!r[i])return console.warn("Options passed to vue-multiselect do not contain groups, despite the config."),[];var u=o(r[i],t,e,l);return u.length?(a={},n(a,s,r[s]),n(a,i,u),a):[];});};}Object.defineProperty(e,"__esModule",{value:!0});var c="function"==typeof Symbol&&"symbol"==_typeof(Symbol.iterator)?function(t){return typeof t==="undefined"?"undefined":_typeof(t);}:function(t){return t&&"function"==typeof Symbol&&t.constructor===Symbol&&t!==Symbol.prototype?"symbol":typeof t==="undefined"?"undefined":_typeof(t);},h=i(2),p=function(t){return t&&t.__esModule?t:{default:t};}(h),d=function d(){for(var t=arguments.length,e=Array(t),i=0;i<t;i++){e[i]=arguments[i];}return function(t){return e.reduce(function(t,e){return e(t);},t);};};e.default={data:function data(){return{search:"",isOpen:!1,prefferedOpenDirection:"below",optimizedHeight:this.maxHeight,internalValue:this.value||0===this.value?(0,p.default)(Array.isArray(this.value)?this.value:[this.value]):[]};},props:{internalSearch:{type:Boolean,default:!0},options:{type:Array,required:!0},multiple:{type:Boolean,default:!1},value:{type:null,default:function _default(){return[];}},trackBy:{type:String},label:{type:String},searchable:{type:Boolean,default:!0},clearOnSelect:{type:Boolean,default:!0},hideSelected:{type:Boolean,default:!1},placeholder:{type:String,default:"Select option"},allowEmpty:{type:Boolean,default:!0},resetAfter:{type:Boolean,default:!1},closeOnSelect:{type:Boolean,default:!0},customLabel:{type:Function,default:function _default(t,e){return s(t)?"":e?t[e]:t;}},taggable:{type:Boolean,default:!1},tagPlaceholder:{type:String,default:"Press enter to create a tag"},max:{type:Number},id:{default:null},optionsLimit:{type:Number,default:1e3},groupValues:{type:String},groupLabel:{type:String},blockKeys:{type:Array,default:function _default(){return[];}},preserveSearch:{type:Boolean,default:!1}},mounted:function mounted(){this.multiple||this.clearOnSelect||console.warn("[Vue-Multiselect warn]: ClearOnSelect and Multiple props can’t be both set to false.");},computed:{filteredOptions:function filteredOptions(){var t=this.search||"",e=t.toLowerCase(),i=this.options.concat();return this.internalSearch?(i=this.groupValues?this.filterAndFlat(i,e,this.label):o(i,e,this.label,this.customLabel),i=this.hideSelected?i.filter(this.isNotSelected):i):i=this.groupValues?a(this.groupValues,this.groupLabel)(i):i,this.taggable&&e.length&&!this.isExistingOption(e)&&i.unshift({isTag:!0,label:t}),i.slice(0,this.optionsLimit);},valueKeys:function valueKeys(){var t=this;return this.trackBy?this.internalValue.map(function(e){return e[t.trackBy];}):this.internalValue;},optionKeys:function optionKeys(){var t=this;return(this.groupValues?this.flatAndStrip(this.options):this.options).map(function(e){return t.customLabel(e,t.label).toString().toLowerCase();});},currentOptionLabel:function currentOptionLabel(){return this.multiple?this.searchable?"":this.placeholder:this.internalValue[0]?this.getOptionLabel(this.internalValue[0]):this.searchable?"":this.placeholder;}},watch:{internalValue:function internalValue(t,e){this.resetAfter&&this.internalValue.length&&(this.search="",this.internalValue=[]);},search:function search(){this.$emit("search-change",this.search,this.id);},value:function value(t){this.internalValue=this.getInternalValue(t);}},methods:{getValue:function getValue(){return this.multiple?(0,p.default)(this.internalValue):0===this.internalValue.length?null:(0,p.default)(this.internalValue[0]);},getInternalValue:function getInternalValue(t){return null===t||void 0===t?[]:this.multiple?(0,p.default)(t):(0,p.default)([t]);},filterAndFlat:function filterAndFlat(t,e,i){return d(u(e,i,this.groupValues,this.groupLabel,this.customLabel),a(this.groupValues,this.groupLabel))(t);},flatAndStrip:function flatAndStrip(t){return d(a(this.groupValues,this.groupLabel),r)(t);},updateSearch:function updateSearch(t){this.search=t;},isExistingOption:function isExistingOption(t){return!!this.options&&this.optionKeys.indexOf(t)>-1;},isSelected:function isSelected(t){var e=this.trackBy?t[this.trackBy]:t;return this.valueKeys.indexOf(e)>-1;},isNotSelected:function isNotSelected(t){return!this.isSelected(t);},getOptionLabel:function getOptionLabel(t){return s(t)?"":t.isTag?t.label:t.$isLabel?t.$groupLabel:this.customLabel(t,this.label)||"";},select:function select(t,e){if(!(-1!==this.blockKeys.indexOf(e)||this.disabled||t.$isLabel||t.$isDisabled||this.max&&this.multiple&&this.internalValue.length===this.max)){if(t.isTag)this.$emit("tag",t.label,this.id),this.search="",this.closeOnSelect&&!this.multiple&&this.deactivate();else{if(this.isSelected(t))return void("Tab"!==e&&this.removeElement(t));this.multiple?this.internalValue.push(t):this.internalValue=[t],this.$emit("select",(0,p.default)(t),this.id),this.$emit("input",this.getValue(),this.id),this.clearOnSelect&&(this.search="");}this.closeOnSelect&&this.deactivate();}},removeElement:function removeElement(t){var e=!(arguments.length>1&&void 0!==arguments[1])||arguments[1];if(!this.disabled){if(!this.allowEmpty&&this.internalValue.length<=1)return void this.deactivate();var i="object"===(void 0===t?"undefined":c(t))?this.valueKeys.indexOf(t[this.trackBy]):this.valueKeys.indexOf(t);this.internalValue.splice(i,1),this.$emit("remove",(0,p.default)(t),this.id),this.$emit("input",this.getValue(),this.id),this.closeOnSelect&&e&&this.deactivate();}},removeLastElement:function removeLastElement(){-1===this.blockKeys.indexOf("Delete")&&0===this.search.length&&Array.isArray(this.internalValue)&&this.removeElement(this.internalValue[this.internalValue.length-1],!1);},activate:function activate(){var t=this;this.isOpen||this.disabled||(this.adjustPosition(),this.groupValues&&0===this.pointer&&this.filteredOptions.length&&(this.pointer=1),this.isOpen=!0,this.searchable?(this.preserveSearch||(this.search=""),this.$nextTick(function(){return t.$refs.search.focus();})):this.$el.focus(),this.$emit("open",this.id));},deactivate:function deactivate(){this.isOpen&&(this.isOpen=!1,this.searchable?this.$refs.search.blur():this.$el.blur(),this.preserveSearch||(this.search=""),this.$emit("close",this.getValue(),this.id));},toggle:function toggle(){this.isOpen?this.deactivate():this.activate();},adjustPosition:function adjustPosition(){if("undefined"!=typeof window){var t=this.$el.getBoundingClientRect().top,e=window.innerHeight-this.$el.getBoundingClientRect().bottom;e>this.maxHeight||e>t||"below"===this.openDirection||"bottom"===this.openDirection?(this.prefferedOpenDirection="below",this.optimizedHeight=Math.min(e,this.maxHeight)-40):(this.prefferedOpenDirection="above",this.optimizedHeight=Math.min(t,this.maxHeight)-40);}}}};},function(t,e,i){"use strict";Object.defineProperty(e,"__esModule",{value:!0}),e.default={data:function data(){return{pointer:0,visibleElements:this.maxHeight/this.optionHeight};},props:{showPointer:{type:Boolean,default:!0},optionHeight:{type:Number,default:40}},computed:{pointerPosition:function pointerPosition(){return this.pointer*this.optionHeight;}},watch:{filteredOptions:function filteredOptions(){this.pointerAdjust();}},methods:{optionHighlight:function optionHighlight(t,e){return{"multiselect__option--highlight":t===this.pointer&&this.showPointer,"multiselect__option--selected":this.isSelected(e)};},addPointerElement:function addPointerElement(){var t=arguments.length>0&&void 0!==arguments[0]?arguments[0]:"Enter",e=t.key;this.filteredOptions.length>0&&this.select(this.filteredOptions[this.pointer],e),this.pointerReset();},pointerForward:function pointerForward(){this.pointer<this.filteredOptions.length-1&&(this.pointer++,this.$refs.list.scrollTop<=this.pointerPosition-this.visibleElements*this.optionHeight&&(this.$refs.list.scrollTop=this.pointerPosition-(this.visibleElements-1)*this.optionHeight),this.filteredOptions[this.pointer].$isLabel&&this.pointerForward());},pointerBackward:function pointerBackward(){this.pointer>0?(this.pointer--,this.$refs.list.scrollTop>=this.pointerPosition&&(this.$refs.list.scrollTop=this.pointerPosition),this.filteredOptions[this.pointer].$isLabel&&this.pointerBackward()):this.filteredOptions[0].$isLabel&&this.pointerForward();},pointerReset:function pointerReset(){this.closeOnSelect&&(this.pointer=0,this.$refs.list&&(this.$refs.list.scrollTop=0));},pointerAdjust:function pointerAdjust(){this.pointer>=this.filteredOptions.length-1&&(this.pointer=this.filteredOptions.length?this.filteredOptions.length-1:0);},pointerSet:function pointerSet(t){this.pointer=t;}}};},function(t,e,i){"use strict";function n(t){if(Array.isArray(t))return t.map(n);if(t&&"object"===(void 0===t?"undefined":s(t))){for(var e={},i=Object.keys(t),l=0,o=i.length;l<o;l++){var r=i[l];e[r]=n(t[r]);}return e;}return t;}Object.defineProperty(e,"__esModule",{value:!0});var s="function"==typeof Symbol&&"symbol"==_typeof(Symbol.iterator)?function(t){return typeof t==="undefined"?"undefined":_typeof(t);}:function(t){return t&&"function"==typeof Symbol&&t.constructor===Symbol&&t!==Symbol.prototype?"symbol":typeof t==="undefined"?"undefined":_typeof(t);};e.default=n;},function(t,e,i){i(6);var n=i(7)(i(5),i(8),null,null);t.exports=n.exports;},function(t,e,i){"use strict";function n(t){return t&&t.__esModule?t:{default:t};}Object.defineProperty(e,"__esModule",{value:!0}),e.deepClone=e.pointerMixin=e.multiselectMixin=e.Multiselect=void 0;var s=i(3),l=n(s),o=i(0),r=n(o),a=i(1),u=n(a),c=i(2),h=n(c);e.default=l.default,e.Multiselect=l.default,e.multiselectMixin=r.default,e.pointerMixin=u.default,e.deepClone=h.default;},function(t,e,i){"use strict";function n(t){return t&&t.__esModule?t:{default:t};}Object.defineProperty(e,"__esModule",{value:!0});var s=i(0),l=n(s),o=i(1),r=n(o);e.default={name:"vue-multiselect",mixins:[l.default,r.default],props:{name:{type:String,default:""},selectLabel:{type:String,default:"Press enter to select"},selectedLabel:{type:String,default:"Selected"},deselectLabel:{type:String,default:"Press enter to remove"},showLabels:{type:Boolean,default:!0},limit:{type:Number,default:99999},maxHeight:{type:Number,default:300},limitText:{type:Function,default:function _default(t){return"and "+t+" more";}},loading:{type:Boolean,default:!1},disabled:{type:Boolean,default:!1},openDirection:{type:String,default:""},showNoResults:{type:Boolean,default:!0},tabindex:{type:Number,default:0}},computed:{visibleValue:function visibleValue(){return this.multiple?this.internalValue.slice(0,this.limit):[];},deselectLabelText:function deselectLabelText(){return this.showLabels?this.deselectLabel:"";},selectLabelText:function selectLabelText(){return this.showLabels?this.selectLabel:"";},selectedLabelText:function selectedLabelText(){return this.showLabels?this.selectedLabel:"";},inputStyle:function inputStyle(){if(this.multiple&&this.value&&this.value.length)return this.isOpen?{width:"auto"}:{display:"none"};},contentStyle:function contentStyle(){return this.options.length?{display:"inline-block"}:{display:"block"};},isAbove:function isAbove(){return"above"===this.openDirection||"top"===this.openDirection||"below"!==this.openDirection&&"bottom"!==this.openDirection&&"above"===this.prefferedOpenDirection;}}};},function(t,e){},function(t,e){t.exports=function(t,e,i,n){var s,l=t=t||{},o=_typeof(t.default);"object"!==o&&"function"!==o||(s=t,l=t.default);var r="function"==typeof l?l.options:l;if(e&&(r.render=e.render,r.staticRenderFns=e.staticRenderFns),i&&(r._scopeId=i),n){var a=Object.create(r.computed||null);Object.keys(n).forEach(function(t){var e=n[t];a[t]=function(){return e;};}),r.computed=a;}return{esModule:s,exports:l,options:r};};},function(t,e){t.exports={render:function render(){var t=this,e=t.$createElement,i=t._self._c||e;return i("div",{staticClass:"multiselect",class:{"multiselect--active":t.isOpen,"multiselect--disabled":t.disabled,"multiselect--above":t.isAbove},attrs:{tabindex:t.tabindex},on:{focus:function focus(e){t.activate();},blur:function blur(e){!t.searchable&&t.deactivate();},keydown:[function(e){return"button"in e||!t._k(e.keyCode,"down",40)?e.target!==e.currentTarget?null:(e.preventDefault(),void t.pointerForward()):null;},function(e){return"button"in e||!t._k(e.keyCode,"up",38)?e.target!==e.currentTarget?null:(e.preventDefault(),void t.pointerBackward()):null;},function(e){return"button"in e||!t._k(e.keyCode,"enter",13)||!t._k(e.keyCode,"tab",9)?(e.stopPropagation(),e.target!==e.currentTarget?null:void t.addPointerElement(e)):null;}],keyup:function keyup(e){if(!("button"in e)&&t._k(e.keyCode,"esc",27))return null;t.deactivate();}}},[t._t("carret",[i("div",{staticClass:"multiselect__select",on:{mousedown:function mousedown(e){e.preventDefault(),e.stopPropagation(),t.toggle();}}})]),t._v(" "),t._t("clear",null,{search:t.search}),t._v(" "),i("div",{ref:"tags",staticClass:"multiselect__tags"},[i("div",{directives:[{name:"show",rawName:"v-show",value:t.visibleValue.length>0,expression:"visibleValue.length > 0"}],staticClass:"multiselect__tags-wrap"},[t._l(t.visibleValue,function(e){return[t._t("tag",[i("span",{staticClass:"multiselect__tag"},[i("span",{domProps:{textContent:t._s(t.getOptionLabel(e))}}),t._v(" "),i("i",{staticClass:"multiselect__tag-icon",attrs:{"aria-hidden":"true",tabindex:"1"},on:{keydown:function keydown(i){if(!("button"in i)&&t._k(i.keyCode,"enter",13))return null;i.preventDefault(),t.removeElement(e);},mousedown:function mousedown(i){i.preventDefault(),t.removeElement(e);}}})])],{option:e,search:t.search,remove:t.removeElement})];})],2),t._v(" "),t.internalValue&&t.internalValue.length>t.limit?[i("strong",{staticClass:"multiselect__strong",domProps:{textContent:t._s(t.limitText(t.internalValue.length-t.limit))}})]:t._e(),t._v(" "),i("transition",{attrs:{name:"multiselect__loading"}},[t._t("loading",[i("div",{directives:[{name:"show",rawName:"v-show",value:t.loading,expression:"loading"}],staticClass:"multiselect__spinner"})])],2),t._v(" "),t.searchable?i("input",{ref:"search",staticClass:"multiselect__input",style:t.inputStyle,attrs:{name:t.name,id:t.id,type:"text",autocomplete:"off",placeholder:t.placeholder,disabled:t.disabled},domProps:{value:t.isOpen?t.search:t.currentOptionLabel},on:{input:function input(e){t.updateSearch(e.target.value);},focus:function focus(e){e.preventDefault(),t.activate();},blur:function blur(e){e.preventDefault(),t.deactivate();},keyup:function keyup(e){if(!("button"in e)&&t._k(e.keyCode,"esc",27))return null;t.deactivate();},keydown:[function(e){if(!("button"in e)&&t._k(e.keyCode,"down",40))return null;e.preventDefault(),t.pointerForward();},function(e){if(!("button"in e)&&t._k(e.keyCode,"up",38))return null;e.preventDefault(),t.pointerBackward();},function(e){return"button"in e||!t._k(e.keyCode,"enter",13)?(e.preventDefault(),e.stopPropagation(),e.target!==e.currentTarget?null:void t.addPointerElement(e)):null;},function(e){if(!("button"in e)&&t._k(e.keyCode,"delete",[8,46]))return null;e.stopPropagation(),t.removeLastElement();}]}}):t._e(),t._v(" "),t.searchable?t._e():i("span",{staticClass:"multiselect__single",domProps:{textContent:t._s(t.currentOptionLabel)}})],2),t._v(" "),i("transition",{attrs:{name:"multiselect"}},[i("div",{directives:[{name:"show",rawName:"v-show",value:t.isOpen,expression:"isOpen"}],ref:"list",staticClass:"multiselect__content-wrapper",style:{maxHeight:t.optimizedHeight+"px"},on:{mousedown:function mousedown(t){t.preventDefault();}}},[i("ul",{staticClass:"multiselect__content",style:t.contentStyle},[t._t("beforeList"),t._v(" "),t.multiple&&t.max===t.internalValue.length?i("li",[i("span",{staticClass:"multiselect__option"},[t._t("maxElements",[t._v("Maximum of "+t._s(t.max)+" options selected. First remove a selected option to select another.")])],2)]):t._e(),t._v(" "),!t.max||t.internalValue.length<t.max?t._l(t.filteredOptions,function(e,n){return i("li",{key:n,staticClass:"multiselect__element"},[e&&(e.$isLabel||e.$isDisabled)?t._e():i("span",{staticClass:"multiselect__option",class:t.optionHighlight(n,e),attrs:{"data-select":e&&e.isTag?t.tagPlaceholder:t.selectLabelText,"data-selected":t.selectedLabelText,"data-deselect":t.deselectLabelText},on:{click:function click(i){i.stopPropagation(),t.select(e);},mouseenter:function mouseenter(e){if(e.target!==e.currentTarget)return null;t.pointerSet(n);}}},[t._t("option",[i("span",[t._v(t._s(t.getOptionLabel(e)))])],{option:e,search:t.search})],2),t._v(" "),e&&(e.$isLabel||e.$isDisabled)?i("span",{staticClass:"multiselect__option multiselect__option--disabled",class:t.optionHighlight(n,e)},[t._t("option",[i("span",[t._v(t._s(t.getOptionLabel(e)))])],{option:e,search:t.search})],2):t._e()]);}):t._e(),t._v(" "),i("li",{directives:[{name:"show",rawName:"v-show",value:t.showNoResults&&0===t.filteredOptions.length&&t.search&&!t.loading,expression:"showNoResults && (filteredOptions.length === 0 && search && !loading)"}]},[i("span",{staticClass:"multiselect__option"},[t._t("noResult",[t._v("No elements found. Consider changing the search query.")])],2)]),t._v(" "),t._t("afterList")],2)])])],2);},staticRenderFns:[]};}]);});
...
var instanceData=typeof childVal==='function'?childVal.call(vm):childVal;var defaultData=typeof parentVal==='function'?parentVal.call(vm):undefined;if(instanceData){return mergeData(instanceData,defaultData);}else{return defaultData;}};}}strats.data=function(parentVal,childVal,vm){if(!vm){if(childVal&&typeof childVal!=='function'){process.env.NODE_ENV!=='production'&&warn('The "data" option should be a function '+'that returns a per-instance value in component '+'definitions.',vm);return parentVal;}return mergeDataOrFn.call(this,parentVal,childVal);}return mergeDataOrFn(parentVal,childVal,vm);};/**
...
observerState.shouldConvert=isRoot;var loop=function loop(key){keys.push(key);var value=validateProp(key,propsOptions,propsData,vm);/* istanbul ignore else */if(process.env.NODE_ENV!=='production'){if(isReservedAttribute(key)||config.isReservedAttr(key)){warn("\""+key+"\" is a reserved attribute and cannot be used as component prop.",vm);}defineReactive$$1(props,key,value,function(){if(vm.$parent&&!isUpdatingChildComponent){warn("Avoid mutating a prop directly since the value will be "+"overwritten whenever the parent component re-renders. "+"Instead, use a data or computed property based on the prop's "+"value. Prop being mutated: \""+key+"\"",vm);}});}else{defineReactive$$1(props,key,value);}// static props are already proxied on the component's prototype
...
vm._uid=uid$1++;var startTag,endTag;/* istanbul ignore if */if(process.env.NODE_ENV!=='production'&&config.performance&&mark){startTag="vue-perf-init:"+vm._uid;endTag="vue-perf-end:"+vm._uid;mark(startTag);}// a flag to avoid this being observed
...
/* istanbul ignore if */if(process.env.NODE_ENV!=='production'&&warn&&modifiers&&modifiers.prevent&&modifiers.passive){warn('passive and prevent can\'t be used together. '+'Passive handler can\'t prevent default event.');}// check capture modifier
...
function genOnce(el,state){el.onceProcessed=true;if(el.if&&!el.ifProcessed){return genIf(el,state);}else if(el.staticInFor){var key='';var parent=el.parent;while(parent){if(parent.for){key=parent.key;break;}parent=parent.parent;}if(!key){process.env.NODE_ENV!=='production'&&state.warn("v-once can only be used inside v-for that is keyed. ");return genElement(el,state);}return"_o("+genElement(el,state)+","+state.onceId++ +(key?","+key:"")+")";}else{return genStatic(el,state);}}function genIf(el,state,altGen,altEmpty){el.ifProcessed=true;// avoid recursion
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0__babel_loader_node_modules_vue_loader_lib_selector_type_script_index_0_configured_action_name_list_vue__ = __webpack_require__(71);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0__babel_loader_node_modules_vue_loader_lib_selector_type_script_index_0_configured_action_name_list_vue___default = __webpack_require__.n(__WEBPACK_IMPORTED_MODULE_0__babel_loader_node_modules_vue_loader_lib_selector_type_script_index_0_configured_action_name_list_vue__);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1__node_modules_vue_loader_lib_template_compiler_index_id_data_v_06022668_hasScoped_false_node_modules_vue_loader_lib_selector_type_template_index_0_configured_action_name_list_vue__ = __webpack_require__(72);
var disposed = false
...
var Component = normalizeComponent(
  __WEBPACK_IMPORTED_MODULE_0__babel_loader_node_modules_vue_loader_lib_selector_type_script_index_0_configured_action_name_list_vue___default.a,
  __WEBPACK_IMPORTED_MODULE_1__node_modules_vue_loader_lib_template_compiler_index_id_data_v_06022668_hasScoped_false_node_modules_vue_loader_lib_selector_type_template_index_0_configured_action_name_list_vue__["a" /* default */],
  __vue_styles__,
  __vue_scopeId__,
  __vue_module_identifier__
)
Component.options.__file = "Resources/public/js/editor/src/workflow/components/configured-action-name-list.vue"
if (Component.esModule && Object.keys(Component.esModule).some(function (key) {return key !== "default" && key.substr(0, 2) !== "__"})) {console.error("named exports are not supported in *.vue files.")}
if (Component.options.functional) {console.error("[vue-loader] configured-action-name-list.vue: functional components are not supported with templates, they should use render functions.")}
...
if (false) {(function () {
  ...
  module.hot.accept()
  if (!module.hot.data) {
    hotAPI.createRecord("data-v-06022668", Component.options)
  } else {
    hotAPI.reload("data-v-06022668", Component.options)
  }
...
plugins.forEach(function(plugin){return plugin(this$1);});if(Vue.config.devtools){devtoolPlugin(this);}};var prototypeAccessors={state:{}};prototypeAccessors.state.get=function(){return this._vm._data.$$state;};prototypeAccessors.state.set=function(v){if(process.env.NODE_ENV!=='production'){assert(false,"Use store.replaceState() to explicit replace store state.");}};Store.prototype.commit=function commit(_type,_payload,_options){var this$1=this;// check object-style commit
...
var ref=unifyObjectStyle(_type,_payload);var type=ref.type;var payload=ref.payload;var entry=this._actions[type];if(!entry){if(process.env.NODE_ENV!=='production'){console.error("[vuex] unknown action type: "+type);}return;}return entry.length>1?Promise.all(entry.map(function(handler){return handler(payload);})):entry[0](payload);};Store.prototype.subscribe=function subscribe(fn){var subs=this._subscribers;if(subs.indexOf(fn)<0){subs.push(fn);}return function(){var i=subs.indexOf(fn);if(i>-1){subs.splice(i,1);}};};Store.prototype.watch=function watch(getter,cb,options){var this$1=this;if(process.env.NODE_ENV!=='production'){assert(typeof getter==='function',"store.watch only accepts a function.");}return this._watcherVM.$watch(function(){return getter(this$1.state,this$1.getters);},cb,options);};Store.prototype.replaceState=function replaceState(state){var this$1=this;this._withCommit(function(){this$1._vm._data.$$state=state;});};Store.prototype.registerModule=function registerModule(path,rawModule){if(typeof path==='string'){path=[path];}if(process.env.NODE_ENV!=='production'){assert(Array.isArray(path),"module path must be a string or an Array.");assert(path.length>0,'cannot register the root module by using registerModule.');}this._modules.register(path,rawModule);installModule(this,this.state,path,this._modules.get(path));// reset store to update getters...
 ...
 */var root=function root(options$$1,next){var url=next(options$$1);if(isString(options$$1.root)&&!/^(https?:)?\//.test(url)){url=trimEnd(options$$1.root,'/')+'/'+url;}return url;};/**
 * Query Parameter Transform.
 */var query=function query(options$$1,next){var urlParams=Object.keys(Url.options.params),query={},url=next(options$$1);each(options$$1.params,function(value,key){if(urlParams.indexOf(key)===-1){query[key]=value;}});query=Url.params(query);if(query){url+=(url.indexOf('?')==-1?'?':'&')+query;}return url;};/**
 ...
 */var xhrClient=function xhrClient(request){return new PromiseObj(function(resolve){var xhr=new XMLHttpRequest(),handler=function handler(event){var response=request.respondWith('response'in xhr?xhr.response:xhr.responseText,{status:xhr.status===1223?204:xhr.status,// IE9 status bug
...
"use strict";
Object.defineProperty(__webpack_exports__, "__esModule", { value: true });
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0__babel_loader_node_modules_vue_loader_lib_selector_type_script_index_0_parameter_vue__ = __webpack_require__(25);
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1__node_modules_vue_loader_lib_template_compiler_index_id_data_v_3cf3f7ad_hasScoped_false_node_modules_vue_loader_lib_selector_type_template_index_0_parameter_vue__ = __webpack_require__(26);
var disposed = false
...
var Component = normalizeComponent(
  ...
  __WEBPACK_IMPORTED_MODULE_1__node_modules_vue_loader_lib_template_compiler_index_id_data_v_3cf3f7ad_hasScoped_false_node_modules_vue_loader_lib_selector_type_template_index_0_parameter_vue__["a" /* default */],
  __vue_styles__,
  __vue_scopeId__,
  __vue_module_identifier__
)
...
if (Component.esModule && Object.keys(Component.esModule).some(function (key) {return key !== "default" && key.substr(0, 2) !== "__"})) {console.error("named exports are not supported in *.vue files.")}
if (Component.options.functional) {console.error("[vue-loader] parameter.vue: functional components are not supported with templates, they should use render functions.")}
...
if (false) {(function () {
  ...
  module.hot.accept()
  if (!module.hot.data) {
    hotAPI.createRecord("data-v-3cf3f7ad", Component.options)
  } else {
    hotAPI.reload("data-v-3cf3f7ad", Component.options)
  }
  module.hot.dispose(function (data) {
    disposed = true
  })
...
var update = __webpack_require__(10)("b0b2a218", content, false);
// Hot Module Replacement
if(false) {
 // When the styles change, update the <style> tags
 if(!content.locals) {
   module.hot.accept("!!../../../../../../../node_modules/css-loader/index.js?sourceMap!../../../../../../../node_modules/vue-loader/lib/style-compiler/index.js?{\"vue\":true,\"id\":\"data-v-3cf3f7ad\",\"scoped\":false,\"hasInlineConfig\":false}!../../../../../../../node_modules/vue-loader/lib/selector.js?type=styles&index=0!./parameter.vue", function() {
     var newContent = require("!!../../../../../../../node_modules/css-loader/index.js?sourceMap!../../../../../../../node_modules/vue-loader/lib/style-compiler/index.js?{\"vue\":true,\"id\":\"data-v-3cf3f7ad\",\"scoped\":false,\"hasInlineConfig\":false}!../../../../../../../node_modules/vue-loader/lib/selector.js?type=styles&index=0!./parameter.vue");
...
if (false) {
  module.hot.accept()
  if (module.hot.data) {
     require("vue-hot-reload-api").rerender("data-v-3cf3f7ad", esExports)
  }
}
...
"use strict";
Object.defineProperty(__webpack_exports__, "__esModule", { value: true });
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0__babel_loader_node_modules_vue_loader_lib_selector_type_script_index_0_json_raw_button_vue__ = __webpack_require__(34);
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1__node_modules_vue_loader_lib_template_compiler_index_id_data_v_167d3c00_hasScoped_false_node_modules_vue_loader_lib_selector_type_template_index_0_json_raw_button_vue__ = __webpack_require__(35);
var disposed = false
function injectStyle (ssrContext) {
  if (disposed) return
...
var Component = normalizeComponent(
  ...
  __WEBPACK_IMPORTED_MODULE_1__node_modules_vue_loader_lib_template_compiler_index_id_data_v_167d3c00_hasScoped_false_node_modules_vue_loader_lib_selector_type_template_index_0_json_raw_button_vue__["a" /* default */],
  __vue_styles__,
  __vue_scopeId__,
  __vue_module_identifier__
)
...
if (Component.esModule && Object.keys(Component.esModule).some(function (key) {return key !== "default" && key.substr(0, 2) !== "__"})) {console.error("named exports are not supported in *.vue files.")}
if (Component.options.functional) {console.error("[vue-loader] json-raw-button.vue: functional components are not supported with templates, they should use render functions.")}
...
if (false) {(function () {
  ...
  module.hot.accept()
  if (!module.hot.data) {
    hotAPI.createRecord("data-v-167d3c00", Component.options)
  } else {
    hotAPI.reload("data-v-167d3c00", Component.options)
  }
  module.hot.dispose(function (data) {
    disposed = true
  })
...
if(content.locals) module.exports = content.locals;
// add the styles to the DOM
var update = __webpack_require__(10)("8df5e51c", content, false);
// Hot Module Replacement
if(false) {
 // When the styles change, update the <style> tags
 if(!content.locals) {
   module.hot.accept("!!../../../../../../../node_modules/css-loader/index.js?sourceMap!../../../../../../../node_modules/vue-loader/lib/style-compiler/index.js?{\"vue\":true,\"id\":\"data-v-167d3c00\",\"scoped\":false,\"hasInlineConfig\":false}!../../../../../../../node_modules/vue-loader/lib/selector.js?type=styles&index=0!./json-raw-button.vue", function() {
     var newContent = require("!!../../../../../../../node_modules/css-loader/index.js?sourceMap!../../../../../../../node_modules/vue-loader/lib/style-compiler/index.js?{\"vue\":true,\"id\":\"data-v-167d3c00\",\"scoped\":false,\"hasInlineConfig\":false}!../../../../../../../node_modules/vue-loader/lib/selector.js?type=styles&index=0!./json-raw-button.vue");
     if(typeof newContent === 'string') newContent = [[module.id, newContent, '']];
     update(newContent);
   });
 }
...
var render = function () {var _vm=this;var _h=_vm.$createElement;var _c=_vm._self._c||_h;
  return _c('div', [_c('i', {
  ...
  }), _vm._v(" "), (_vm.showModal) ? _c('modal', [_c('button', {
    staticClass: "close",
    attrs: {
      "type": "button"
    },
    ...
    slot: "header"
  }, [_vm._v(_vm._s(_vm.header))]), _vm._v(" "), _c('textarea', {
    staticClass: "raw-json",
    attrs: {
      "readonly": ""
    },
    slot: "body"
  }, [_vm._v(_vm._s(_vm.body))]), _vm._v(" "), _c('p', {
    slot: "footer"
  }, [_vm._v(_vm._s(_vm.footer))])]) : _vm._e()], 1)
}
var staticRenderFns = []
render._withStripped = true
var esExports = { render: render, staticRenderFns: staticRenderFns }
...
if (false) {
  module.hot.accept()
  if (module.hot.data) {
     require("vue-hot-reload-api").rerender("data-v-167d3c00", esExports)
  }
}
...
"use strict";
Object.defineProperty(__webpack_exports__, "__esModule", { value: true });
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0__babel_loader_node_modules_vue_loader_lib_selector_type_script_index_0_new_next_action_vue__ = __webpack_require__(73);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0__babel_loader_node_modules_vue_loader_lib_selector_type_script_index_0_new_next_action_vue___default = __webpack_require__.n(__WEBPACK_IMPORTED_MODULE_0__babel_loader_node_modules_vue_loader_lib_selector_type_script_index_0_new_next_action_vue__);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1__node_modules_vue_loader_lib_template_compiler_index_id_data_v_44c70313_hasScoped_false_node_modules_vue_loader_lib_selector_type_template_index_0_new_next_action_vue__ = __webpack_require__(74);
var disposed = false
var normalizeComponent = __webpack_require__(8)
/* script */
...
var __vue_module_identifier__ = null
var Component = normalizeComponent(
  __WEBPACK_IMPORTED_MODULE_0__babel_loader_node_modules_vue_loader_lib_selector_type_script_index_0_new_next_action_vue___default.a,
  __WEBPACK_IMPORTED_MODULE_1__node_modules_vue_loader_lib_template_compiler_index_id_data_v_44c70313_hasScoped_false_node_modules_vue_loader_lib_selector_type_template_index_0_new_next_action_vue__["a" /* default */],
  __vue_styles__,
  __vue_scopeId__,
  __vue_module_identifier__
)
Component.options.__file = "Resources/public/js/editor/src/workflow/components/new-next-action.vue"
if (Component.esModule && Object.keys(Component.esModule).some(function (key) {return key !== "default" && key.substr(0, 2) !== "__"})) {console.error("named exports are not supported in *.vue files.")}
if (Component.options.functional) {console.error("[vue-loader] new-next-action.vue: functional components are not supported with templates, they should use render functions.")}
...
if (false) {(function () {
  ...
  module.hot.accept()
  if (!module.hot.data) {
    hotAPI.createRecord("data-v-44c70313", Component.options)
  } else {
    hotAPI.reload("data-v-44c70313", Component.options)
  }
  module.hot.dispose(function (data) {
    disposed = true
  })
...
"use strict";
Object.defineProperty(__webpack_exports__, "__esModule", { value: true });
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0__babel_loader_node_modules_vue_loader_lib_selector_type_script_index_0_next_action_vue__ = __webpack_require__(75);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0__babel_loader_node_modules_vue_loader_lib_selector_type_script_index_0_next_action_vue___default = __webpack_require__.n(__WEBPACK_IMPORTED_MODULE_0__babel_loader_node_modules_vue_loader_lib_selector_type_script_index_0_next_action_vue__);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1__node_modules_vue_loader_lib_template_compiler_index_id_data_v_1cdaf580_hasScoped_false_node_modules_vue_loader_lib_selector_type_template_index_0_next_action_vue__ = __webpack_require__(76);
var disposed = false
var normalizeComponent = __webpack_require__(8)
/* script */
...
var __vue_module_identifier__ = null
var Component = normalizeComponent(
  __WEBPACK_IMPORTED_MODULE_0__babel_loader_node_modules_vue_loader_lib_selector_type_script_index_0_next_action_vue___default.a,
  __WEBPACK_IMPORTED_MODULE_1__node_modules_vue_loader_lib_template_compiler_index_id_data_v_1cdaf580_hasScoped_false_node_modules_vue_loader_lib_selector_type_template_index_0_next_action_vue__["a" /* default */],
  __vue_styles__,
  __vue_scopeId__,
  __vue_module_identifier__
)
Component.options.__file = "Resources/public/js/editor/src/workflow/components/next-action.vue"
if (Component.esModule && Object.keys(Component.esModule).some(function (key) {return key !== "default" && key.substr(0, 2) !== "__"})) {console.error("named exports are not supported in *.vue files.")}
if (Component.options.functional) {console.error("[vue-loader] next-action.vue: functional components are not supported with templates, they should use render functions.")}
...
if (false) {(function () {
  ...
  module.hot.accept()
  if (!module.hot.data) {
    hotAPI.createRecord("data-v-1cdaf580", Component.options)
  } else {
    hotAPI.reload("data-v-1cdaf580", Component.options)
  }
  module.hot.dispose(function (data) {
    disposed = true
  })
...
"use strict";
Object.defineProperty(__webpack_exports__, "__esModule", { value: true });
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0__babel_loader_node_modules_vue_loader_lib_selector_type_script_index_0_editor_vue__ = __webpack_require__(55);
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1__node_modules_vue_loader_lib_template_compiler_index_id_data_v_6c6b8ba6_hasScoped_false_node_modules_vue_loader_lib_selector_type_template_index_0_editor_vue__ = __webpack_require__(84);
var disposed = false
var normalizeComponent = __webpack_require__(8)
/* script */
...
var Component = normalizeComponent(
  ...
  __WEBPACK_IMPORTED_MODULE_1__node_modules_vue_loader_lib_template_compiler_index_id_data_v_6c6b8ba6_hasScoped_false_node_modules_vue_loader_lib_selector_type_template_index_0_editor_vue__["a" /* default */],
  __vue_styles__,
  __vue_scopeId__,
  __vue_module_identifier__
)
Component.options.__file = "Resources/public/js/editor/src/workflow/components/editor.vue"
if (Component.esModule && Object.keys(Component.esModule).some(function (key) {return key !== "default" && key.substr(0, 2) !== "__"})) {console.error("named exports are not supported in *.vue files.")}
...
if (false) {(function () {
  ...
  module.hot.accept()
  if (!module.hot.data) {
    hotAPI.createRecord("data-v-6c6b8ba6", Component.options)
  } else {
    hotAPI.reload("data-v-6c6b8ba6", Component.options)
  }
  module.hot.dispose(function (data) {
    disposed = true
  })
...
"use strict";
Object.defineProperty(exports,"__esModule",{value:true});var _newAction=__webpack_require__(56);var _newAction2=_interopRequireDefault(_newAction);var _actionsConfiguration=__webpack_require__(61);var _actionsConfiguration2=_interopRequireDefault(_actionsConfiguration);var _workflow=__webpack_require__(69);var _workflow2=_interopRequireDefault(_workflow);var _jsonRawButton=__webpack_require__(31);var _jsonRawButton2=_interopRequireDefault(_jsonRawButton);function _interopRequireDefault(obj){return obj&&obj.__esModule?obj:{default:obj};}//
//
//
//
//
...
//
//
exports.default={components:{'new-action':_newAction2.default,'actions-configuration':_actionsConfiguration2.default,'workflow':_workflow2.default,'modal':_jsonRawButton2.default},computed:{rawJSON:function rawJSON(){return this.$store.getters.getRawJSON;}}};
...
"use strict";
Object.defineProperty(__webpack_exports__, "__esModule", { value: true });
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0__babel_loader_node_modules_vue_loader_lib_selector_type_script_index_0_new_action_vue__ = __webpack_require__(59);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0__babel_loader_node_modules_vue_loader_lib_selector_type_script_index_0_new_action_vue___default = __webpack_require__.n(__WEBPACK_IMPORTED_MODULE_0__babel_loader_node_modules_vue_loader_lib_selector_type_script_index_0_new_action_vue__);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1__node_modules_vue_loader_lib_template_compiler_index_id_data_v_ab3a167a_hasScoped_false_node_modules_vue_loader_lib_selector_type_template_index_0_new_action_vue__ = __webpack_require__(60);
var disposed = false
function injectStyle (ssrContext) {
  if (disposed) return
...
var __vue_module_identifier__ = null
var Component = normalizeComponent(
  __WEBPACK_IMPORTED_MODULE_0__babel_loader_node_modules_vue_loader_lib_selector_type_script_index_0_new_action_vue___default.a,
  __WEBPACK_IMPORTED_MODULE_1__node_modules_vue_loader_lib_template_compiler_index_id_data_v_ab3a167a_hasScoped_false_node_modules_vue_loader_lib_selector_type_template_index_0_new_action_vue__["a" /* default */],
  __vue_styles__,
  __vue_scopeId__,
  __vue_module_identifier__
)
Component.options.__file = "Resources/public/js/editor/src/workflow/components/new-action.vue"
if (Component.esModule && Object.keys(Component.esModule).some(function (key) {return key !== "default" && key.substr(0, 2) !== "__"})) {console.error("named exports are not supported in *.vue files.")}
if (Component.options.functional) {console.error("[vue-loader] new-action.vue: functional components are not supported with templates, they should use render functions.")}
...
if (false) {(function () {
  ...
  module.hot.accept()
  if (!module.hot.data) {
    hotAPI.createRecord("data-v-ab3a167a", Component.options)
  } else {
    hotAPI.reload("data-v-ab3a167a", Component.options)
  }
  module.hot.dispose(function (data) {
    disposed = true
  })
...
if(content.locals) module.exports = content.locals;
// add the styles to the DOM
var update = __webpack_require__(10)("249bcb27", content, false);
// Hot Module Replacement
if(false) {
 // When the styles change, update the <style> tags
 if(!content.locals) {
   module.hot.accept("!!../../../../../../../node_modules/css-loader/index.js?sourceMap!../../../../../../../node_modules/vue-loader/lib/style-compiler/index.js?{\"vue\":true,\"id\":\"data-v-ab3a167a\",\"scoped\":false,\"hasInlineConfig\":false}!../../../../../../../node_modules/vue-loader/lib/selector.js?type=styles&index=0!./new-action.vue", function() {
     var newContent = require("!!../../../../../../../node_modules/css-loader/index.js?sourceMap!../../../../../../../node_modules/vue-loader/lib/style-compiler/index.js?{\"vue\":true,\"id\":\"data-v-ab3a167a\",\"scoped\":false,\"hasInlineConfig\":false}!../../../../../../../node_modules/vue-loader/lib/selector.js?type=styles&index=0!./new-action.vue");
     if(typeof newContent === 'string') newContent = [[module.id, newContent, '']];
     update(newContent);
   });
 }
...
"use strict";
Object.defineProperty(exports,"__esModule",{value:true});var _vueMultiselect=__webpack_require__(11);var _vueMultiselect2=_interopRequireDefault(_vueMultiselect);function _interopRequireDefault(obj){return obj&&obj.__esModule?obj:{default:obj};}exports.default={props:['index'],data:function data(){return{selectedActionService:null,errorMessage:''};},components:{'multiselect':_vueMultiselect2.default},computed:{actionList:function actionList(){var actionList=this.$store.getters.getActionList;if(null===this.selectedActionService&&actionList.length>0){this.selectedActionService=actionList[0];}return actionList;}},methods:{createAction:function createAction(){try{var payload={name:'',service:this.selectedActionService.name,parameters:{}};this.$store.commit('addAction',payload);this.errorMessage='';}catch(error){this.errorMessage=error.message;}}},watch:{selectedActionService:{handler:function handler(selectedActionService){if(null!=selectedActionService){this.$store.dispatch('setActionParameters',{http:this.$http,service:selectedActionService.name});}}}}};//
//
//
//
//
...
var render = function () {var _vm=this;var _h=_vm.$createElement;var _c=_vm._self._c||_h;
  return _c('div', {
    staticClass: "row new-action"
  }, [(_vm.errorMessage !== '') ? _c('div', {
    staticClass: "col-md-12 error"
    ...
    model: {
      value: (_vm.selectedActionService),
      callback: function($$v) {
        _vm.selectedActionService = $$v
      },
      expression: "selectedActionService"
    }
  })], 1), _vm._v(" "), _c('div', {
...
if (false) {
  module.hot.accept()
  if (module.hot.data) {
     require("vue-hot-reload-api").rerender("data-v-ab3a167a", esExports)
  }
}
...
"use strict";
Object.defineProperty(__webpack_exports__, "__esModule", { value: true });
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0__babel_loader_node_modules_vue_loader_lib_selector_type_script_index_0_actions_configuration_vue__ = __webpack_require__(62);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0__babel_loader_node_modules_vue_loader_lib_selector_type_script_index_0_actions_configuration_vue___default = __webpack_require__.n(__WEBPACK_IMPORTED_MODULE_0__babel_loader_node_modules_vue_loader_lib_selector_type_script_index_0_actions_configuration_vue__);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1__node_modules_vue_loader_lib_template_compiler_index_id_data_v_30159616_hasScoped_false_node_modules_vue_loader_lib_selector_type_template_index_0_actions_configuration_vue__ = __webpack_require__(68);
var disposed = false
var normalizeComponent = __webpack_require__(8)
/* script */
...
var __vue_module_identifier__ = null
var Component = normalizeComponent(
  __WEBPACK_IMPORTED_MODULE_0__babel_loader_node_modules_vue_loader_lib_selector_type_script_index_0_actions_configuration_vue___default.a,
  __WEBPACK_IMPORTED_MODULE_1__node_modules_vue_loader_lib_template_compiler_index_id_data_v_30159616_hasScoped_false_node_modules_vue_loader_lib_selector_type_template_index_0_actions_configuration_vue__["a" /* default */],
  __vue_styles__,
  __vue_scopeId__,
  __vue_module_identifier__
)
Component.options.__file = "Resources/public/js/editor/src/workflow/components/actions-configuration.vue"
if (Component.esModule && Object.keys(Component.esModule).some(function (key) {return key !== "default" && key.substr(0, 2) !== "__"})) {console.error("named exports are not supported in *.vue files.")}
if (Component.options.functional) {console.error("[vue-loader] actions-configuration.vue: functional components are not supported with templates, they should use render functions.")}
...
if (false) {(function () {
  ...
  module.hot.accept()
  if (!module.hot.data) {
    hotAPI.createRecord("data-v-30159616", Component.options)
  } else {
    hotAPI.reload("data-v-30159616", Component.options)
  }
  module.hot.dispose(function (data) {
    disposed = true
  })
...
"use strict";
Object.defineProperty(exports,"__esModule",{value:true});var _actionConfiguration=__webpack_require__(63);var _actionConfiguration2=_interopRequireDefault(_actionConfiguration);function _interopRequireDefault(obj){return obj&&obj.__esModule?obj:{default:obj};}exports.default={props:['index'],computed:{actionsConfiguration:function actionsConfiguration(){return this.$store.getters.getActionsConfiguration;}},components:{'action-configuration':_actionConfiguration2.default},methods:{/**
         * Get the action parameters from the action list
         *
         * @param actionName
         *
         * @return {}
         */getActionParameters:function getActionParameters(actionName){return this.$store.getters.getAction(actionName).parameters;},/**
         * Remove an action
         *
         * @param action
         * @param index
         */removeAction:function removeAction(action,index){this.$store.commit('removeAction',{actionIndex:index});}}};//
//
//
//
//
...
"use strict";
Object.defineProperty(__webpack_exports__, "__esModule", { value: true });
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0__babel_loader_node_modules_vue_loader_lib_selector_type_script_index_0_action_configuration_vue__ = __webpack_require__(66);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0__babel_loader_node_modules_vue_loader_lib_selector_type_script_index_0_action_configuration_vue___default = __webpack_require__.n(__WEBPACK_IMPORTED_MODULE_0__babel_loader_node_modules_vue_loader_lib_selector_type_script_index_0_action_configuration_vue__);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1__node_modules_vue_loader_lib_template_compiler_index_id_data_v_7bca9142_hasScoped_false_node_modules_vue_loader_lib_selector_type_template_index_0_action_configuration_vue__ = __webpack_require__(67);
var disposed = false
function injectStyle (ssrContext) {
  if (disposed) return
...
var __vue_module_identifier__ = null
var Component = normalizeComponent(
  __WEBPACK_IMPORTED_MODULE_0__babel_loader_node_modules_vue_loader_lib_selector_type_script_index_0_action_configuration_vue___default.a,
  __WEBPACK_IMPORTED_MODULE_1__node_modules_vue_loader_lib_template_compiler_index_id_data_v_7bca9142_hasScoped_false_node_modules_vue_loader_lib_selector_type_template_index_0_action_configuration_vue__["a" /* default */],
  __vue_styles__,
  __vue_scopeId__,
  __vue_module_identifier__
)
Component.options.__file = "Resources/public/js/editor/src/workflow/components/action-configuration.vue"
if (Component.esModule && Object.keys(Component.esModule).some(function (key) {return key !== "default" && key.substr(0, 2) !== "__"})) {console.error("named exports are not supported in *.vue files.")}
if (Component.options.functional) {console.error("[vue-loader] action-configuration.vue: functional components are not supported with templates, they should use render functions.")}
...
if (false) {(function () {
  ...
  module.hot.accept()
  if (!module.hot.data) {
    hotAPI.createRecord("data-v-7bca9142", Component.options)
  } else {
    hotAPI.reload("data-v-7bca9142", Component.options)
  }
  module.hot.dispose(function (data) {
    disposed = true
  })
...
if(content.locals) module.exports = content.locals;
// add the styles to the DOM
var update = __webpack_require__(10)("6193f48a", content, false);
// Hot Module Replacement
if(false) {
 // When the styles change, update the <style> tags
 if(!content.locals) {
   module.hot.accept("!!../../../../../../../node_modules/css-loader/index.js?sourceMap!../../../../../../../node_modules/vue-loader/lib/style-compiler/index.js?{\"vue\":true,\"id\":\"data-v-7bca9142\",\"scoped\":false,\"hasInlineConfig\":false}!../../../../../../../node_modules/vue-loader/lib/selector.js?type=styles&index=0!./action-configuration.vue", function() {
     var newContent = require("!!../../../../../../../node_modules/css-loader/index.js?sourceMap!../../../../../../../node_modules/vue-loader/lib/style-compiler/index.js?{\"vue\":true,\"id\":\"data-v-7bca9142\",\"scoped\":false,\"hasInlineConfig\":false}!../../../../../../../node_modules/vue-loader/lib/selector.js?type=styles&index=0!./action-configuration.vue");
     if(typeof newContent === 'string') newContent = [[module.id, newContent, '']];
     update(newContent);
   });
 }
...
"use strict";
Object.defineProperty(exports,"__esModule",{value:true});var _parameter=__webpack_require__(22);var _parameter2=_interopRequireDefault(_parameter);var _vueEditorCommons=__webpack_require__(0);__webpack_require__(27);__webpack_require__(29);function _interopRequireDefault(obj){return obj&&obj.__esModule?obj:{default:obj};}//
//
//
//
//
...
//
//
exports.default={props:['index'],data:function data(){return{actionName:null,errorMessage:''};},computed:{id:function id(){return'action_parameters'+_vueEditorCommons.utils.generateUniqueId();},action:function action(){var action=this.$store.getters.getActionConfiguration(this.index);this.actionName=action.name;return action;},requiredParameters:function requiredParameters(){return _vueEditorCommons.utils.filterObject(this.getActionParameters(this.action.service),function(element){return element.options.required;});},optionalParameters:function optionalParameters(){return _vueEditorCommons.utils.filterObject(this.getActionParameters(this.action.service),function(element){return!element.options.required;});},description:function description(){return this.$store.getters.getActionDescription(this.action.service);}},components:{'parameter':_parameter2.default},methods:{/**
         * Update parameter
         *
         * @param {Object} parameter - the parameter object.
         */updateParameter:function updateParameter(parameter){var payload={actionIndex:this.index,parameter:parameter};if(0===parameter.value.length){this.$store.commit('removeParameter',payload);}else{this.$store.commit('updateParameter',payload);}},/**
         * Get the parameters for an action
         *
         * @returns {boolean}
         */getActionParameters:function getActionParameters(actionService){var action=this.$store.getters.getAction(actionService);if(null!=action){return action.parameters;}return{};},/**
         * Remove an action
         */remove:function remove(){this.$emit('remove');},/**
         * Has optional parameters.
         *
         * @returns boolean
         */hasOptionalParameters:function hasOptionalParameters(){return Object.keys(this.optionalParameters).length>0;},/**
         * Update action name.
         *
         * @param {string} name
         */updateActionName:function updateActionName(newActionName){try{var payload={actionIndex:this.index,name:newActionName};this.$store.commit('updateActionName',payload);this.errorMessage='';}catch(error){this.errorMessage=error.message;}}}};
...
var render = function () {var _vm=this;var _h=_vm.$createElement;var _c=_vm._self._c||_h;
  return _c('div', {
    staticClass: "configuration-box parameters"
  }, [_c('button', {
    staticClass: "close",
    attrs: {
      "aria-label": "Close"
  ...
  }, [_vm._v("×")])]), _vm._v(" "), _c('h5', [_vm._v("Chosen service: "), _c('strong', [_vm._v(_vm._s(_vm.action.service))])]), _vm._v(" "), _c('div', {
    staticClass: "description"
  }, [_vm._v(_vm._s(_vm.description))]), _vm._v(" "), _c('div', {
    staticClass: "collapsed-block"
  }, [_c('div', {
    staticClass: "form-group"
  }, [_c('label', [_vm._v("name")]), _vm._v(" "), (_vm.errorMessage !== '') ? _c('span', {
    staticClass: "error"
  }, [_vm._v("\n                " + _vm._s(_vm.errorMessage) + "\n                "), _c('i', {
    staticClass: "fa fa-exclamation-circle"
    ...
    on: {
      "input": [function($event) {
        ...
        _vm.actionName = $event.target.value
      }, function($event) {
        _vm.updateActionName(_vm.actionName)
      }]
    }
  })]), _vm._v(" "), _vm._l((_vm.requiredParameters), function(parameterOption, parameterName) {
    return _c('parameter', {
      key: parameterName,
      attrs: {
        "name": parameterName,
  ...
  }), _vm._v(" "), (_vm.hasOptionalParameters()) ? _c('a', {
  ...
  }, [_vm._v("\n            Optional parameters\n            "), _vm._m(0)]) : _vm._e(), _vm._v(" "), (_vm.hasOptionalParameters()) ? _c('div', {
  ...
  }, _vm._l((_vm.optionalParameters), function(parameterOption, parameterName) {
    return _c('parameter', {
      key: parameterName,
      attrs: {
        "name": parameterName,
...
if (false) {
  module.hot.accept()
  if (module.hot.data) {
     require("vue-hot-reload-api").rerender("data-v-7bca9142", esExports)
  }
}
...
"use strict";
var render = function () {var _vm=this;var _h=_vm.$createElement;var _c=_vm._self._c||_h;
  return _c('div', _vm._l((_vm.actionsConfiguration), function(action, index) {
    return _c('div', {
      key: index
    }, [_c('action-configuration', {
      key: index,
      attrs: {
        "index": index
      },
...
if (false) {
  module.hot.accept()
  if (module.hot.data) {
     require("vue-hot-reload-api").rerender("data-v-30159616", esExports)
  }
}
...
"use strict";
Object.defineProperty(__webpack_exports__, "__esModule", { value: true });
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0__babel_loader_node_modules_vue_loader_lib_selector_type_script_index_0_workflow_vue__ = __webpack_require__(70);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0__babel_loader_node_modules_vue_loader_lib_selector_type_script_index_0_workflow_vue___default = __webpack_require__.n(__WEBPACK_IMPORTED_MODULE_0__babel_loader_node_modules_vue_loader_lib_selector_type_script_index_0_workflow_vue__);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1__node_modules_vue_loader_lib_template_compiler_index_id_data_v_5b2bed7f_hasScoped_false_node_modules_vue_loader_lib_selector_type_template_index_0_workflow_vue__ = __webpack_require__(83);
var disposed = false
var normalizeComponent = __webpack_require__(8)
/* script */
...
var __vue_module_identifier__ = null
var Component = normalizeComponent(
  __WEBPACK_IMPORTED_MODULE_0__babel_loader_node_modules_vue_loader_lib_selector_type_script_index_0_workflow_vue___default.a,
  __WEBPACK_IMPORTED_MODULE_1__node_modules_vue_loader_lib_template_compiler_index_id_data_v_5b2bed7f_hasScoped_false_node_modules_vue_loader_lib_selector_type_template_index_0_workflow_vue__["a" /* default */],
  __vue_styles__,
  __vue_scopeId__,
  __vue_module_identifier__
)
Component.options.__file = "Resources/public/js/editor/src/workflow/components/workflow.vue"
if (Component.esModule && Object.keys(Component.esModule).some(function (key) {return key !== "default" && key.substr(0, 2) !== "__"})) {console.error("named exports are not supported in *.vue files.")}
if (Component.options.functional) {console.error("[vue-loader] workflow.vue: functional components are not supported with templates, they should use render functions.")}
...
if (false) {(function () {
  ...
  module.hot.accept()
  if (!module.hot.data) {
    hotAPI.createRecord("data-v-5b2bed7f", Component.options)
  } else {
    hotAPI.reload("data-v-5b2bed7f", Component.options)
  }
  module.hot.dispose(function (data) {
    disposed = true
  })
...
"use strict";
Object.defineProperty(exports,"__esModule",{value:true});var _configuredActionNameList=__webpack_require__(15);var _configuredActionNameList2=_interopRequireDefault(_configuredActionNameList);var _newNextAction=__webpack_require__(36);var _newNextAction2=_interopRequireDefault(_newNextAction);var _nextAction=__webpack_require__(37);var _nextAction2=_interopRequireDefault(_nextAction);var _newFlow=__webpack_require__(77);var _newFlow2=_interopRequireDefault(_newFlow);var _flow=__webpack_require__(80);var _flow2=_interopRequireDefault(_flow);function _interopRequireDefault(obj){return obj&&obj.__esModule?obj:{default:obj};}exports.default={props:['name','firstActionName'],computed:{flow:function flow(){var workflowConfiguration=this.$store.getters.getWorkflowConfiguration;if(null!=workflowConfiguration){return workflowConfiguration.flows;}},workflowFirstActionName:function workflowFirstActionName(){var workflowConfiguration=this.$store.getters.getWorkflowConfiguration;if(null!=workflowConfiguration){return workflowConfiguration.first_action_name;}},configuredActionNames:function configuredActionNames(){var actions=this.$store.getters.getActionsConfiguration;var names=actions.map(function(action){return action.name;});if(null===this.selectedRoute&&names.length>0){this.selectedRoute=names[0];}return names;}},components:{'configured-action-name-list':_configuredActionNameList2.default,'new-next-action':_newNextAction2.default,'next-action':_nextAction2.default,'new-flow':_newFlow2.default,'flow':_flow2.default},methods:{removeActionToFlow:function removeActionToFlow(actionName){this.$store.commit('removeActionToFlow',actionName);},/**
         * Update the first action name.
         *
         * @param {string} selectedName - The selected name.
         */updateFirstActionName:function updateFirstActionName(selectedName){this.$store.commit('updateFirstActionName',selectedName);},/**
         * Update the first action name.
         *
         * @param {string} defaultNextAction - The default next action name.
         */updateDefaultNextAction:function updateDefaultNextAction(defaultNextAction){this.$store.commit('updateDefaultNextAction',defaultNextAction);},/**
         * Update the first action name.
         *
         * @param {string} selectedName - The selected name.
         */updateWorkflowName:function updateWorkflowName(event){this.$store.commit('updateWorkflowName',event.target.value);}},watch:{workflowName:{handler:function handler(newWorkflowName){this.$store.commit('updateWorkflowName',newWorkflowName);}}}};//
//
//
//
//
...
"use strict";
Object.defineProperty(exports,"__esModule",{value:true});var _vueMultiselect=__webpack_require__(11);var _vueMultiselect2=_interopRequireDefault(_vueMultiselect);function _interopRequireDefault(obj){return obj&&obj.__esModule?obj:{default:obj};}exports.default={props:['index','value','previousAction'],data:function data(){return{selectedName:this.value,errorMessage:''};},components:{'multiselect':_vueMultiselect2.default},computed:{configuredActionNames:function configuredActionNames(){var actionIndex=void 0;var actions=this.$store.getters.getActionsConfiguration;var names=[];if(null!=actions&&actions.length>0){names=actions.map(function(action){return action.name;});}if(null!=this.previousAction){if((actionIndex=names.indexOf(this.previousAction))!==-1){names.splice(actionIndex,1);}}if(null==this.selectedName&&names.length>0){this.selectedName=names[0];}return names;}},watch:{selectedName:{handler:function handler(selectedName){this.$emit('changed',selectedName);}}}};//
//
//
//
//
...
var render = function () {var _vm=this;var _h=_vm.$createElement;var _c=_vm._self._c||_h;
  return _c('div', [_c('multiselect', {
    attrs: {
      "options": _vm.configuredActionNames,
      "selectLabel": "",
...
if (false) {
  module.hot.accept()
  if (module.hot.data) {
     require("vue-hot-reload-api").rerender("data-v-06022668", esExports)
  }
}
...
"use strict";
Object.defineProperty(exports,"__esModule",{value:true});var _configuredActionNameList=__webpack_require__(15);var _configuredActionNameList2=_interopRequireDefault(_configuredActionNameList);function _interopRequireDefault(obj){return obj&&obj.__esModule?obj:{default:obj};}exports.default={props:['previousAction'],data:function data(){return{selectedName:null,errorMessage:''};},components:{'configured-action-name-list':_configuredActionNameList2.default},methods:{updateSelectedName:function updateSelectedName(name){this.selectedName=name;},createNextAction:function createNextAction(){try{var payload={previousAction:this.previousAction,actionName:this.selectedName,condition:''};this.$store.commit('addNextAction',payload);}catch(error){this.errorMessage=error.message;}}}};//
//
//
//
//
...
var render = function () {var _vm=this;var _h=_vm.$createElement;var _c=_vm._self._c||_h;
  return _c('div', {
    staticClass: "row"
  }, [_c('configured-action-name-list', {
    staticClass: "col-md-10",
    attrs: {
      "previousAction": _vm.previousAction
    },
    on: {
      "changed": _vm.updateSelectedName
    }
  }), _vm._v(" "), _c('div', {
    staticClass: "col-md-2"
  }, [_c('button', {
...
if (false) {
  module.hot.accept()
  if (module.hot.data) {
     require("vue-hot-reload-api").rerender("data-v-44c70313", esExports)
  }
}
...
"use strict";
Object.defineProperty(exports,"__esModule",{value:true});var _configuredActionNameList=__webpack_require__(15);var _configuredActionNameList2=_interopRequireDefault(_configuredActionNameList);function _interopRequireDefault(obj){return obj&&obj.__esModule?obj:{default:obj};}exports.default={props:['index','previousAction','nextAction'],components:{'configured-action-name-list':_configuredActionNameList2.default},methods:{remove:function remove(){this.$emit('removed',{index:this.index,previousAction:this.previousAction});},updateNextActionName:function updateNextActionName(selectedName){var payload={index:this.index,previousAction:this.previousAction,name:selectedName};this.$store.commit('updateNextActionName',payload);}},watch:{'nextAction.condition':{handler:function handler(newCondition){var payload={index:this.index,previousAction:this.previousAction,condition:newCondition};this.$store.commit('updateNextActionCondition',payload);},deep:true}}};//
//
//
//
//
...
var render = function () {var _vm=this;var _h=_vm.$createElement;var _c=_vm._self._c||_h;
  return _c('div', [_c('button', {
  ...
  }, [_vm._v("×")])]), _vm._v(" "), _c('h5', [_vm._v("Next action: "), _c('strong', [_vm._v(_vm._s(_vm.nextAction.name))])]), _vm._v(" "), _c('div', {
    staticClass: "form-group"
  }, [_c('label', [_vm._v("condition")]), _vm._v(" "), _c('input', {
    directives: [{
      name: "model",
      rawName: "v-model",
      value: (_vm.nextAction.condition),
      expression: "nextAction.condition"
    }],
    staticClass: "form-control",
    attrs: {
      "type": "text"
    ...
    on: {
      "input": function($event) {
        if ($event.target.composing) { return; }
        _vm.nextAction.condition = $event.target.value
      }
    }
  })])])
}
...
if (false) {
  module.hot.accept()
  if (module.hot.data) {
     require("vue-hot-reload-api").rerender("data-v-1cdaf580", esExports)
  }
}
...
"use strict";
Object.defineProperty(__webpack_exports__, "__esModule", { value: true });
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0__babel_loader_node_modules_vue_loader_lib_selector_type_script_index_0_new_flow_vue__ = __webpack_require__(78);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0__babel_loader_node_modules_vue_loader_lib_selector_type_script_index_0_new_flow_vue___default = __webpack_require__.n(__WEBPACK_IMPORTED_MODULE_0__babel_loader_node_modules_vue_loader_lib_selector_type_script_index_0_new_flow_vue__);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1__node_modules_vue_loader_lib_template_compiler_index_id_data_v_21da74fb_hasScoped_false_node_modules_vue_loader_lib_selector_type_template_index_0_new_flow_vue__ = __webpack_require__(79);
var disposed = false
var normalizeComponent = __webpack_require__(8)
/* script */
...
var __vue_module_identifier__ = null
var Component = normalizeComponent(
  __WEBPACK_IMPORTED_MODULE_0__babel_loader_node_modules_vue_loader_lib_selector_type_script_index_0_new_flow_vue___default.a,
  __WEBPACK_IMPORTED_MODULE_1__node_modules_vue_loader_lib_template_compiler_index_id_data_v_21da74fb_hasScoped_false_node_modules_vue_loader_lib_selector_type_template_index_0_new_flow_vue__["a" /* default */],
  __vue_styles__,
  __vue_scopeId__,
  __vue_module_identifier__
)
Component.options.__file = "Resources/public/js/editor/src/workflow/components/new-flow.vue"
if (Component.esModule && Object.keys(Component.esModule).some(function (key) {return key !== "default" && key.substr(0, 2) !== "__"})) {console.error("named exports are not supported in *.vue files.")}
if (Component.options.functional) {console.error("[vue-loader] new-flow.vue: functional components are not supported with templates, they should use render functions.")}
...
if (false) {(function () {
  ...
  module.hot.accept()
  if (!module.hot.data) {
    hotAPI.createRecord("data-v-21da74fb", Component.options)
  } else {
    hotAPI.reload("data-v-21da74fb", Component.options)
  }
  module.hot.dispose(function (data) {
    disposed = true
  })
...
"use strict";
Object.defineProperty(exports,"__esModule",{value:true});var _configuredActionNameList=__webpack_require__(15);var _configuredActionNameList2=_interopRequireDefault(_configuredActionNameList);function _interopRequireDefault(obj){return obj&&obj.__esModule?obj:{default:obj};}exports.default={data:function data(){return{selectedName:null,errorMessage:''};},components:{'configured-action-name-list':_configuredActionNameList2.default},methods:{updateSelectedName:function updateSelectedName(name){this.selectedName=name;},createFlow:function createFlow(){try{var payload={selectedName:this.selectedName,next:[],default_next:''};this.$store.commit('addActionToFlow',payload);}catch(error){this.errorMessage=error.message;}}}};//
//
//
//
//
...
if (false) {
  module.hot.accept()
  if (module.hot.data) {
     require("vue-hot-reload-api").rerender("data-v-21da74fb", esExports)
  }
}
...
"use strict";
Object.defineProperty(__webpack_exports__, "__esModule", { value: true });
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0__babel_loader_node_modules_vue_loader_lib_selector_type_script_index_0_flow_vue__ = __webpack_require__(81);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0__babel_loader_node_modules_vue_loader_lib_selector_type_script_index_0_flow_vue___default = __webpack_require__.n(__WEBPACK_IMPORTED_MODULE_0__babel_loader_node_modules_vue_loader_lib_selector_type_script_index_0_flow_vue__);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1__node_modules_vue_loader_lib_template_compiler_index_id_data_v_37f14924_hasScoped_false_node_modules_vue_loader_lib_selector_type_template_index_0_flow_vue__ = __webpack_require__(82);
var disposed = false
var normalizeComponent = __webpack_require__(8)
/* script */
...
var __vue_module_identifier__ = null
var Component = normalizeComponent(
  __WEBPACK_IMPORTED_MODULE_0__babel_loader_node_modules_vue_loader_lib_selector_type_script_index_0_flow_vue___default.a,
  __WEBPACK_IMPORTED_MODULE_1__node_modules_vue_loader_lib_template_compiler_index_id_data_v_37f14924_hasScoped_false_node_modules_vue_loader_lib_selector_type_template_index_0_flow_vue__["a" /* default */],
  __vue_styles__,
  __vue_scopeId__,
  __vue_module_identifier__
)
Component.options.__file = "Resources/public/js/editor/src/workflow/components/flow.vue"
if (Component.esModule && Object.keys(Component.esModule).some(function (key) {return key !== "default" && key.substr(0, 2) !== "__"})) {console.error("named exports are not supported in *.vue files.")}
if (Component.options.functional) {console.error("[vue-loader] flow.vue: functional components are not supported with templates, they should use render functions.")}
...
if (false) {(function () {
  ...
  module.hot.accept()
  if (!module.hot.data) {
    hotAPI.createRecord("data-v-37f14924", Component.options)
  } else {
    hotAPI.reload("data-v-37f14924", Component.options)
  }
  module.hot.dispose(function (data) {
    disposed = true
  })
...
"use strict";
Object.defineProperty(exports,"__esModule",{value:true});var _configuredActionNameList=__webpack_require__(15);var _configuredActionNameList2=_interopRequireDefault(_configuredActionNameList);var _newNextAction=__webpack_require__(36);var _newNextAction2=_interopRequireDefault(_newNextAction);var _nextAction=__webpack_require__(37);var _nextAction2=_interopRequireDefault(_nextAction);function _interopRequireDefault(obj){return obj&&obj.__esModule?obj:{default:obj};}exports.default={props:['previousAction','action'],components:{'configured-action-name-list':_configuredActionNameList2.default,'new-next-action':_newNextAction2.default,'next-action':_nextAction2.default},methods:{removeActionToFlow:function removeActionToFlow(actionName){this.$store.commit('removeActionToFlow',actionName);},/**
         * Remove the selected next action.
         *
         * @param {Object} payload
         */removeNextAction:function removeNextAction(payload){this.$store.commit('removeNextAction',payload);},/**
         * Update the first action name.
         *
         * @param {string} defaultNextAction - The default next action name.
         */updateDefaultNextAction:function updateDefaultNextAction(defaultNextAction){this.$store.commit('updateDefaultNextAction',{defaultNext:defaultNextAction,previousAction:this.previousAction});}}};//
//
//
//
//
...
var render = function () {var _vm=this;var _h=_vm.$createElement;var _c=_vm._self._c||_h;
  return _c('div', [_c('button', {
    ...
    on: {
      "click": function($event) {
        $event.preventDefault();
        _vm.removeActionToFlow(_vm.previousAction)
      }
    }
  }, [_c('span', {
    attrs: {
  ...
  }, [_vm._v("×")])]), _vm._v(" "), _c('h4', [_vm._v("Flow configuration for " + _vm._s(_vm.previousAction) + ":")]), _vm._v(" "), _c('div', {
    staticClass: "form-group"
  }, [_c('new-next-action', {
    attrs: {
      "previousAction": _vm.previousAction
    }
  }), _vm._v(" "), _vm._l((_vm.action.next), function(nextAction, index) {
    return _c('next-action', {
      key: index,
      staticClass: "configuration-box",
      attrs: {
        "index": index,
        "previousAction": _vm.previousAction,
      ...
      on: {
        "removed": _vm.removeNextAction
      }
    })
  })], 2), _vm._v(" "), _c('div', {
    staticClass: "form-group"
  }, [_c('label', [_vm._v("default next")]), _vm._v(" "), _c('configured-action-name-list', {
    attrs: {
      "previousAction": _vm.previousAction,
      "value": _vm.action.default_next
    },
    on: {
      "changed": _vm.updateDefaultNextAction
    }
  })], 1)])
}
var staticRenderFns = []
...
if (false) {
  module.hot.accept()
  if (module.hot.data) {
     require("vue-hot-reload-api").rerender("data-v-37f14924", esExports)
  }
}
...
var render = function () {var _vm=this;var _h=_vm.$createElement;var _c=_vm._self._c||_h;
  return _c('div', [_c('div', {
    staticClass: "form-group"
  }, [_c('label', [_vm._v("first action name")]), _vm._v(" "), _c('configured-action-name-list', {
    attrs: {
      "value": _vm.workflowFirstActionName
    },
    on: {
      "changed": _vm.updateFirstActionName
    }
  })], 1), _vm._v(" "), _c('div', {
    staticClass: "form-group"
  }, [_c('label', [_vm._v("flow")]), _vm._v(" "), _c('new-flow'), _vm._v(" "), _vm._l((_vm.flow), function(action, previousAction) {
    return _c('flow', {
      key: previousAction,
      staticClass: "configuration-box",
      attrs: {
...
if (false) {
  module.hot.accept()
  if (module.hot.data) {
     require("vue-hot-reload-api").rerender("data-v-5b2bed7f", esExports)
  }
}
...
var render = function () {var _vm=this;var _h=_vm.$createElement;var _c=_vm._self._c||_h;
  return _c('div', {
    ...
    attrs: {
      "header": 'Workflow raw JSON',
      "body": _vm.rawJSON
    }
  }), _vm._v(" "), _c('h3', [_vm._v("Action settings")]), _vm._v(" "), _c('new-action'), _vm._v(" "), _c('actions-configuration'), _vm._v(" "), _c('h3', [_vm._v("Workflow setting")]), _vm._v(" "), _c('workflow')], 1)
}
var staticRenderFns = []
render._withStripped = true
var esExports = { render: render, staticRenderFns: staticRenderFns }
...
if (false) {
  module.hot.accept()
  if (module.hot.data) {
     require("vue-hot-reload-api").rerender("data-v-6c6b8ba6", esExports)
  }
}
...
"use strict";
Object.defineProperty(exports,"__esModule",{value:true});exports.default={getEditorId:function getEditorId(state){return state.configuration.editorId;},getActionsUrl:function getActionsUrl(state){return state.configuration.api_urls.get_actions;},getActionParametersUrl:function getActionParametersUrl(state){return function(serviceName){return state.configuration.api_urls.get_action_parameters.replace('ACTION_NAME',serviceName);};},getActionList:function getActionList(state){return state.actions;},getAction:function getAction(state){return function(serviceName){return state.actions.find(function(element){return element.name===serviceName;});};},getActionsConfiguration:function getActionsConfiguration(state){return state.data.actions;},getActionConfiguration:function getActionConfiguration(state){return function(index){return state.data.actions[index];};},getWorkflowConfiguration:function getWorkflowConfiguration(state){return state.data.workflow;},getActionDescription:function getActionDescription(state,getters){return function(actionName){var action=getters.getActionList.find(function(element){return element.name===actionName;});if(action){return action.description;}};},/**
   * Return the JSON string of workflow data
   *
   * @returns {string}
   */getRawJSON:function getRawJSON(state){return JSON.stringify(state.data,null,2);}};
...
"use strict";
Object.defineProperty(exports,"__esModule",{value:true});var _vue=__webpack_require__(13);var _vue2=_interopRequireDefault(_vue);var _vueEditorCommons=__webpack_require__(0);function _interopRequireDefault(obj){return obj&&obj.__esModule?obj:{default:obj};}exports.default={/**
   * Initialize workflow data with form data.
   *
   * @param {Object} state - The state.
   */initializeWorkflowData:function initializeWorkflowData(state){if(state.configuration.form.value){var formValue=JSON.parse(state.configuration.form.value);var initialStateData=state.data;state.data=formValue;// If the parsed object is empty; restore initial state data.
if(Object.keys(formValue).length<=0){state.data=initialStateData;}}},/**
   * Set the actions retrieved from the API.
   *
   * @param {Object} state   - The state
   * @param {Array}  actions - The action names
   */setActions:function setActions(state,actions){state.actions=actions.map(function(element){return{name:element};});},/**
   * Set the action parameters.
   *
   * @param {Object} state  - The state
   * @param {Object} action - The action object.
   *
   */setActionParameters:function setActionParameters(state,action){for(var key in action.parameters){action.parameters[key].component_name='component-'+action.parameters[key].form_type;}var _iteratorNormalCompletion=true;var _didIteratorError=false;var _iteratorError=undefined;try{for(var _iterator=state.actions[Symbol.iterator](),_step;!(_iteratorNormalCompletion=(_step=_iterator.next()).done);_iteratorNormalCompletion=true){var configuredAction=_step.value;if(configuredAction.name===action.name){_vue2.default.set(configuredAction,'parameters',action.parameters);_vue2.default.set(configuredAction,'description',action.description);}}}catch(err){_didIteratorError=true;_iteratorError=err;}finally{try{if(!_iteratorNormalCompletion&&_iterator.return){_iterator.return();}}finally{if(_didIteratorError){throw _iteratorError;}}}},/**
   * Add action.
   *
   * @param {Object} state - The state.
   * @param {Object} payload - The object with the action.
   *
   */addAction:function addAction(state,payload){var _iteratorNormalCompletion2=true;var _didIteratorError2=false;var _iteratorError2=undefined;try{for(var _iterator2=state.data.actions[Symbol.iterator](),_step2;!(_iteratorNormalCompletion2=(_step2=_iterator2.next()).done);_iteratorNormalCompletion2=true){var action=_step2.value;if(payload.name===action.name&&payload.service===action.service){throw new Error('You cannot add two times the action "'+payload.service+'". You need to specify the name of the first action before');}}}catch(err){_didIteratorError2=true;_iteratorError2=err;}finally{try{if(!_iteratorNormalCompletion2&&_iterator2.return){_iterator2.return();}}finally{if(_didIteratorError2){throw _iteratorError2;}}}state.data.actions.push(payload);this.commit('updateRawField');},/**
   * Remove action.
   *
   * @param {Object} state - The state.
   * @param {Object} payload - The object with the action.
   *
   */removeAction:function removeAction(state,payload){state.data.actions.splice(payload.actionIndex,1);this.commit('updateRawField');},/**
   * Update the action name in the workflow configuration.
   *
   * @param {Object} state - The state.
   * @param {Object} payload - The payload.
   *
   */updateActionName:function updateActionName(state,payload){var _iteratorNormalCompletion3=true;var _didIteratorError3=false;var _iteratorError3=undefined;try{for(var _iterator3=state.data.actions[Symbol.iterator](),_step3;!(_iteratorNormalCompletion3=(_step3=_iterator3.next()).done);_iteratorNormalCompletion3=true){var action=_step3.value;if(payload.name===action.name){throw new Error('Be careful... The name "'+payload.name+'" is already used');}}}catch(err){_didIteratorError3=true;_iteratorError3=err;}finally{try{if(!_iteratorNormalCompletion3&&_iterator3.return){_iterator3.return();}}finally{if(_didIteratorError3){throw _iteratorError3;}}}state.data.actions[payload.actionIndex].name=payload.name;this.commit('updateRawField');},/**
   * Update parameter.
   *
   * @param {Object} state - The state.
   * @param {Object} payload - The payload.
   *
   */updateParameter:function updateParameter(state,payload){_vue2.default.set(state.data.actions[payload.actionIndex].parameters,payload.parameter.name,payload.parameter.value);this.commit('updateRawField');},/**
   * Remove parameter.
   *
   * @param {Object} state - The state.
   * @param {Object} payload - The payload.
   *
   */removeParameter:function removeParameter(state,payload){_vue2.default.delete(state.data.actions[payload.actionIndex].parameters,payload.parameter.name);this.commit('updateRawField');},/**
   * Update workflow name.
   *
   * @param {Object} state - The state.
   * @param {string} name  - The workflow name.
   */updateWorkflowName:function updateWorkflowName(state,name){state.data.workflow.name=name;this.commit('updateRawField');},/**
   * Update first action name.
   *
   * @param {Object} state - The state.
   * @param {string} name  - The first action name.
   */updateFirstActionName:function updateFirstActionName(state,name){state.data.workflow.first_action_name=name;this.commit('updateRawField');},/**
   * Add an action to the flow
   *
   * @param {Object} state - The state.
   * @param {Object} payload - the payload.
   */addActionToFlow:function addActionToFlow(state,payload){var action={next:payload.next,default_next:payload.default_next};_vue2.default.set(state.data.workflow.flows,payload.selectedName,action);this.commit('updateRawField');},/**
   * Remove an action to the flow
   *
   * @param {Object} state - The state.
   * @param {string} actionName - The action name.
   */removeActionToFlow:function removeActionToFlow(state,actionName){_vue2.default.delete(state.data.workflow.flows,actionName);this.commit('updateRawField');},/**
   * Add a next action to selected action in the flow.
   *
   * @param {Object} state - The state.
   * @param {Object} payload - the payload.
   */addNextAction:function addNextAction(state,payload){var nextAction={name:payload.actionName,condition:payload.condition};state.data.workflow.flows[payload.previousAction].next.push(nextAction);this.commit('updateRawField');},/**
   ...
   */removeNextAction:function removeNextAction(state,payload){_vue2.default.delete(state.data.workflow.flows[payload.previousAction].next,payload.index);this.commit('updateRawField');},/**
   ...
   */updateDefaultNextAction:function updateDefaultNextAction(state,payload){_vue2.default.set(state.data.workflow.flows[payload.previousAction],'default_next',payload.defaultNext);this.commit('updateRawField');},/**
   * Update next action name.
   *
   * @param {Object} state - The state.
   * @param {Object} payload - The payload.
   */updateNextActionName:function updateNextActionName(state,payload){_vue2.default.set(state.data.workflow.flows[payload.action].next[payload.index],'name',payload.name);this.commit('updateRawField');},/**
   * Update next action condition.
   *
   * @param {Object} state - The state.
   * @param {Object} payload - The payload.
   */updateNextActionCondition:function updateNextActionCondition(state,payload){_vue2.default.set(state.data.workflow.flows[payload.previousAction].next[payload.index],'condition',payload.condition);this.commit('updateRawField');},/**
   * Update the form field hidden.
   *
   * @param {Object} state - The state.
   */updateRawField:function updateRawField(state){var actions=state.data.actions;var _iteratorNormalCompletion4=true;var _didIteratorError4=false;var _iteratorError4=undefined;try{for(var _iterator4=actions[Symbol.iterator](),_step4;!(_iteratorNormalCompletion4=(_step4=_iterator4.next()).done);_iteratorNormalCompletion4=true){var action=_step4.value;for(var name in action.parameters){try{action.parameters[name]=JSON.parse(action.parameters[name]);}catch(e){}}}}catch(err){_didIteratorError4=true;_iteratorError4=err;}finally{try{if(!_iteratorNormalCompletion4&&_iterator4.return){_iterator4.return();}}finally{if(_didIteratorError4){throw _iteratorError4;}}}var raw=JSON.stringify(state.data,null,4);var element=document.getElementById(state.configuration.form.id);element.value=raw;}};
...
"use strict";
Object.defineProperty(exports,"__esModule",{value:true});var workflowEditorActions={/**
   * Set the actions retrieved from the API.
   *
   * @param {Object} $store - The store.
   * @param {Object} $http  - The Vue Resource http object.
   */setActions:function setActions($store,$http){workflowEditorActions.handleGetRequest($store.getters.getActionsUrl,$store,$http,function(actions){$store.commit('setActions',actions);});},/**
   * Set the action parameters retrieved from the API.
   *
   * @param {Object} store - The store.
   * @param {Object} payload  - The object with Vue Resource and the action name.
   */setActionParameters:function setActionParameters($store,payload){workflowEditorActions.handleGetRequest($store.getters.getActionParametersUrl(payload.service),$store,payload.http,function(action){$store.commit('setActionParameters',action);});}};exports.default=workflowEditorActions;

/***/ })
]);
//# sourceMappingURL=trigger-workflow-vue-editor.async.js.map