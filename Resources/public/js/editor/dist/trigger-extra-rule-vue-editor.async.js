...
function triggerVueEditor(element, configuration, formProperties) {
  ...
  _vue2.default.component('extract-rule-editor', _editor2.default);

  /**
   * The common state
   */
  var extractRuleEditorStore = new _vuex2.default.Store({
    state: {
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0__babel_loader_node_modules_vue_loader_lib_selector_type_script_index_0_editor_vue__ = __webpack_require__(30);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1__node_modules_vue_loader_lib_template_compiler_index_id_data_v_276f7a14_hasScoped_false_node_modules_vue_loader_lib_selector_type_template_index_0_editor_vue__ = __webpack_require__(43);
var disposed = false
var normalizeComponent = __webpack_require__(8)
/* script */
...
"use strict";
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0__extract_rule_list_vue__ = __webpack_require__(31);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1__extract_rule_configuration_vue__ = __webpack_require__(40);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_2_TaskBundle_common_styles_editor_css__ = __webpack_require__(25);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_2_TaskBundle_common_styles_editor_css___default = __webpack_require__.n(__WEBPACK_IMPORTED_MODULE_2_TaskBundle_common_styles_editor_css__);
//
//
//
//
...
/* harmony default export */ __webpack_exports__["a"] = ({
  components: {
    'extract-rule-list': __WEBPACK_IMPORTED_MODULE_0__extract_rule_list_vue__["a" /* default */],
    'extract-rule-configuration': __WEBPACK_IMPORTED_MODULE_1__extract_rule_configuration_vue__["a" /* default */]
  }
});
...
"use strict";
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0__babel_loader_node_modules_vue_loader_lib_selector_type_script_index_0_extract_rule_list_vue__ = __webpack_require__(36);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1__node_modules_vue_loader_lib_template_compiler_index_id_data_v_77feb58a_hasScoped_false_node_modules_vue_loader_lib_selector_type_template_index_0_extract_rule_list_vue__ = __webpack_require__(39);
var disposed = false
...
var __vue_module_identifier__ = null
var Component = normalizeComponent(
  __WEBPACK_IMPORTED_MODULE_0__babel_loader_node_modules_vue_loader_lib_selector_type_script_index_0_extract_rule_list_vue__["a" /* default */],
...
if(content.locals) module.exports = content.locals;
// add the styles to the DOM
var update = __webpack_require__(34)("7c198ce4", content, false);
// Hot Module Replacement
if(false) {
 // When the styles change, update the <style> tags
 if(!content.locals) {
...
"use strict";
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0_TaskBundle_common_styles_multiselect_css__ = __webpack_require__(37);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0_TaskBundle_common_styles_multiselect_css___default = __webpack_require__.n(__WEBPACK_IMPORTED_MODULE_0_TaskBundle_common_styles_multiselect_css__);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1_vue_multiselect__ = __webpack_require__(10);
...
/* harmony default export */ __webpack_exports__["a"] = ({
  ...
  computed: {
    extractRuleServiceList: function () {
      return this.$store.getters.getExtractRuleList.map(function (element) {
        return element.name;
      });
    }
  }
...
"use strict";
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0__babel_loader_node_modules_vue_loader_lib_selector_type_script_index_0_extract_rule_configuration_vue__ = __webpack_require__(41);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1__node_modules_vue_loader_lib_template_compiler_index_id_data_v_3cd429ba_hasScoped_false_node_modules_vue_loader_lib_selector_type_template_index_0_extract_rule_configuration_vue__ = __webpack_require__(42);
var disposed = false
var normalizeComponent = __webpack_require__(8)
/* script */
...
var __vue_module_identifier__ = null
var Component = normalizeComponent(
  __WEBPACK_IMPORTED_MODULE_0__babel_loader_node_modules_vue_loader_lib_selector_type_script_index_0_extract_rule_configuration_vue__["a" /* default */],
...
"use strict";
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0_TaskBundle_common_components_parameter_vue__ = __webpack_require__(20);
...
/* harmony default export */ __webpack_exports__["a"] = ({
  ...
  components: { 'parameter': __WEBPACK_IMPORTED_MODULE_0_TaskBundle_common_components_parameter_vue__["a" /* default */] },

  computed: {
    id: function () {
      return 'extract_rule_parameters' + __WEBPACK_IMPORTED_MODULE_1_vue_editor_commons__["utils"].generateUniqueId();
    },
    parameters: function () {
      let usedExtractRule = this.$store.getters.getUsedExtractRule;
      let parameters = this.$store.getters.getExtractRuleParameters(usedExtractRule.service);
...
"use strict";
var render = function () {var _vm=this;var _h=_vm.$createElement;var _c=_vm._self._c||_h;
  return (_vm.parameters) ? _c('div', {
    staticClass: "collapsed-block parameters"
  }, [_c('a', {
  ...
  }, _vm._l((_vm.parameters), function(option, name) {
    return _c('parameter', {
      key: name,
      attrs: {
        "name": name,
...
var render = function () {var _vm=this;var _h=_vm.$createElement;var _c=_vm._self._c||_h;
  ...
  }, [_c('extract-rule-list'), _vm._v(" "), _c('extract-rule-configuration')], 1)
}
var staticRenderFns = []
render._withStripped = true
var esExports = { render: render, staticRenderFns: staticRenderFns }
...
exports.default = {
   ...
   * @returns string
   */
  getExtractRuleListApiUrl: function getExtractRuleListApiUrl(state) {
   ...
   * @returns string
   */
  getExtractRuleParametersApiUrl: function getExtractRuleParametersApiUrl(state) {
    return function (serviceName) {
      return state.configuration.api_url.get_extract_rules_parameters.replace('XNAME', serviceName);
    };
  },
   ...
   * @returns []
   */
  getExtractRuleList: function getExtractRuleList(state) {
   ...
   * @returns {Object}
   */
  getUsedExtractRule: function getUsedExtractRule(state) {
   ...
   * @returns {Object}
   */
  getExtractRuleParameters: function getExtractRuleParameters(state, getters) {
    return function (extractRuleServiceName) {
      var extractRule = getters.getExtractRuleList.find(function (element) {
...
exports.default = {
   ...
   */
  setExtractRuleList: function setExtractRuleList(state, extractRuleList) {
   ...
   */
  setExtractRuleParameters: function setExtractRuleParameters(state, payload) {
    var parameters = payload.extractRuleParameters;
    for (var key in parameters) {
      parameters[key].component_name = 'component-' + parameters[key].form_type;
    }

    var extractRule = state.extractRuleList.find(function (element) {
      return element.name === payload.extractRuleName;
    });

    _vue2.default.set(extractRule, 'parameters', payload.extractRuleParameters);
  },
   ...
   */
  updateUsedExtractRuleService: function updateUsedExtractRuleService(state, extractRuleService) {
   ...
   * @param {Object[]} extractRules
   */
  updateUsedExtractRuleParameter: function updateUsedExtractRuleParameter(state, parameter) {
    _vue2.default.set(state.usedExtractRule.parameters, parameter.name, parameter.value);
   ...
   * @param {Object[]} extractRules
   */
  cleanUsedParameters: function cleanUsedParameters(state, parameter) {
    var usedParameters = state.usedExtractRule.parameters;

    var allParameters = state.extractRuleList.find(function (element) {
      return element.name === state.usedExtractRule.service;
    }).parameters;

    for (var usedParameterName in usedParameters) {
      if (typeof allParameters[usedParameterName] === 'undefined') {
        _vue2.default.delete(state.usedExtractRule.parameters, usedParameterName);
      }
    }
   ...
   * @returns []
   */
  initializeUsedExtractRule: function initializeUsedExtractRule(state) {
    var defaultConf = {
      service: null,
      parameters: {}
    };
    ...
    if ('' !== state.formProperties.value) {
      var existingConf = JSON.parse(state.formProperties.value);
      _vue2.default.set(state, 'usedExtractRule', Object.assign(defaultConf, existingConf));
    } else {
      _vue2.default.set(state, 'usedExtractRule', defaultConf);
    }
  },
   ...
   * @returns []
   */
  updateInitialTextareaValue: function updateInitialTextareaValue(state) {
    var rawExtractRule = JSON.stringify(state.usedExtractRule, null, 4);
...
var extractRuleEditorActions = {
   ...
   * @param $http
   */
  setExtractRules: function setExtractRules($store, $http) {
    return new Promise(function (resolve, reject) {
  ...
  setExtractRuleParameters: function setExtractRuleParameters($store, payload) {
    return new Promise(function (resolve, reject) {
...
exports.default = extractRuleEditorActions;
